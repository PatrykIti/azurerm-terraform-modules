...
| [Azure DevOps Extension](./modules/azuredevops_extension/) | ✅ Completed | [ADOEXv1.0.0](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/ADOEXv1.0.0) | Azure DevOps extension module for managing a single Marketplace extension |
| [Azure DevOps Group](./modules/azuredevops_group/) | ✅ Completed | [ADOGv1.0.0](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/ADOGv1.0.0) | Azure DevOps group module for managing a single group with optional strict-child memberships |
| [Azure DevOps Group Entitlement](./modules/azuredevops_group_entitlement/) | 🧪 Development | vUnreleased | Azure DevOps module for managing a single group entitlement |
