...
<!-- MODULE BADGES START -->
[![Azure DevOps Repository](https://img.shields.io/github/v/tag/PatrykIti/azurerm-terraform-modules?filter=ADORv*&label=Azure%20DevOps%20Repository&color=success)](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/ADORv1.0.2)
...
| [Azure DevOps Repository](./modules/azuredevops_repository/) | ✅ Completed | [ADORv1.0.2](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/ADORv1.0.2) | Azure DevOps repository module for managing Git repositories and policies |
