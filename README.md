...
[![Azure DevOps Work Items](https://img.shields.io/github/v/tag/PatrykIti/azurerm-terraform-modules?filter=ADOWKv*&label=Azure%20DevOps%20Work%20Items&color=success)](https://github.com/PatrykIti/azurerm-terraform-modules/releases)
[![Azure DevOps Wiki](https://img.shields.io/github/v/tag/PatrykIti/azurerm-terraform-modules?filter=ADOWIv*&label=Azure%20DevOps%20Wiki&color=success)](https://github.com/PatrykIti/azurerm-terraform-modules/releases)
[![Azure DevOps Variable Groups](https://img.shields.io/github/v/tag/PatrykIti/azurerm-terraform-modules?filter=ADOVGv*&label=Azure%20DevOps%20Variable%20Groups&color=success)](https://github.com/PatrykIti/azurerm-terraform-modules/releases)
[![Azure DevOps Team](https://img.shields.io/github/v/tag/PatrykIti/azurerm-terraform-modules?filter=ADOTv*&label=Azure%20DevOps%20Team&color=success)](https://github.com/PatrykIti/azurerm-terraform-modules/releases)
[![Azure DevOps Service Hooks](https://img.shields.io/github/v/tag/PatrykIti/azurerm-terraform-modules?filter=ADOSHv*&label=Azure%20DevOps%20Service%20Hooks&color=success)](https://github.com/PatrykIti/azurerm-terraform-modules/releases)
[![Azure DevOps Service Endpoints](https://img.shields.io/github/v/tag/PatrykIti/azurerm-terraform-modules?filter=ADOSEv*&label=Azure%20DevOps%20Service%20Endpoints&color=success)](https://github.com/PatrykIti/azurerm-terraform-modules/releases)
[![Azure DevOps Pipelines](https://img.shields.io/github/v/tag/PatrykIti/azurerm-terraform-modules?filter=ADOPIv*&label=Azure%20DevOps%20Pipelines&color=success)](https://github.com/PatrykIti/azurerm-terraform-modules/releases)
<!-- MODULE BADGES END -->
...
| [Log Analytics Workspace](./modules/azurerm_log_analytics_workspace/) | ✅ Completed | [LAWv1.1.0](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/LAWv1.1.0) | Azure Log Analytics Workspace module with workspace-linked sub-resources and diagnostics |
...
| [Azure DevOps Pipelines](./modules/azuredevops_pipelines/) | ✅ Completed | [ADOPIv*](https://github.com/PatrykIti/azurerm-terraform-modules/releases) | Azure DevOps pipelines module for managing build definitions, folders, permissions, and authorizations |
...
| [Azure DevOps Service Endpoints](./modules/azuredevops_serviceendpoint/) | ✅ Completed | [ADOSEv*](https://github.com/PatrykIti/azurerm-terraform-modules/releases) | Azure DevOps service endpoints module for managing service connections and permissions |
| [Azure DevOps Service Hooks](./modules/azuredevops_servicehooks/) | ✅ Completed | [ADOSHv*](https://github.com/PatrykIti/azurerm-terraform-modules/releases) | Azure DevOps service hooks module for managing subscriptions and permissions |
| [Azure DevOps Team](./modules/azuredevops_team/) | ✅ Completed | [ADOTv*](https://github.com/PatrykIti/azurerm-terraform-modules/releases) | Azure DevOps team module for managing teams, members, and administrators |
| [Azure DevOps Variable Groups](./modules/azuredevops_variable_groups/) | ✅ Completed | [ADOVGv*](https://github.com/PatrykIti/azurerm-terraform-modules/releases) | Azure DevOps variable groups module for managing variables and library permissions |
| [Azure DevOps Wiki](./modules/azuredevops_wiki/) | ✅ Completed | [ADOWIv*](https://github.com/PatrykIti/azurerm-terraform-modules/releases) | Azure DevOps wiki module for managing wikis and pages |
| [Azure DevOps Work Items](./modules/azuredevops_work_items/) | ✅ Completed | [ADOWKv*](https://github.com/PatrykIti/azurerm-terraform-modules/releases) | Azure DevOps work items module for managing processes, queries, and permissions |
