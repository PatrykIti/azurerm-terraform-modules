...
| [Managed Redis](./modules/azurerm_managed_redis/) | 🟡 Development | Unreleased | Azure Managed Redis Terraform module with geo-replication membership and diagnostics support |
