...
| [Bastion Host](./modules/azurerm_bastion_host/) | ✅ Completed | [BASTIONv1.0.0](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/BASTIONv1.0.0) | Azure Bastion Host module with host scaling, copy/paste, and diagnostic settings support |
...
| [User Assigned Identity](./modules/azurerm_user_assigned_identity/) | ✅ Completed | [UAIv1.0.0](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/UAIv1.0.0) | Azure User Assigned Identity module with federated identity credential support |
...
| [Key Vault](./modules/azurerm_key_vault/) | ✅ Completed | [KVv1.0.0](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/KVv1.0.0) | Azure Key Vault module with data-plane resources and diagnostic settings |
