...
[![Azure DevOps Pipelines](https://img.shields.io/github/v/tag/PatrykIti/azurerm-terraform-modules?filter=ADOPIv*&label=Azure%20DevOps%20Pipelines&color=success)](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/ADOPIv1.0.0)
...
[![Azure DevOps Project Permissions](https://img.shields.io/github/v/tag/PatrykIti/azurerm-terraform-modules?filter=ADOPPv*&label=Azure%20DevOps%20Project%20Permissions&color=success)](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/ADOPPv2.0.0)
...
[![Azure DevOps Service Endpoints](https://img.shields.io/github/v/tag/PatrykIti/azurerm-terraform-modules?filter=ADOSEv*&label=Azure%20DevOps%20Service%20Endpoints&color=success)](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/ADOSEv1.0.0)
[![Azure DevOps Service Hooks](https://img.shields.io/github/v/tag/PatrykIti/azurerm-terraform-modules?filter=ADOSHv*&label=Azure%20DevOps%20Service%20Hooks&color=success)](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/ADOSHv1.0.0)
[![Azure DevOps Service Principal Entitlement](https://img.shields.io/github/v/tag/PatrykIti/azurerm-terraform-modules?filter=ADOSPEv*&label=Azure%20DevOps%20Service%20Principal%20Entitlement&color=success)](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/ADOSPEv2.0.0)
[![Azure DevOps Team](https://img.shields.io/github/v/tag/PatrykIti/azurerm-terraform-modules?filter=ADOTv*&label=Azure%20DevOps%20Team&color=success)](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/ADOTv1.0.0)
...
[![Managed Redis](https://img.shields.io/github/v/tag/PatrykIti/azurerm-terraform-modules?filter=AMRv*&label=Managed%20Redis&color=success)](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/AMRv1.0.0)
...
| [Managed Redis](./modules/azurerm_managed_redis/) | ✅ Completed | [AMRv1.0.0](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/AMRv1.0.0) | Azure Managed Redis Terraform module with enterprise-grade features |
...
| [Azure DevOps Pipelines](./modules/azuredevops_pipelines/) | ✅ Completed | [ADOPIv1.0.0](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/ADOPIv1.0.0) | Azure DevOps pipelines module for managing a build definition with strict-child permissions and resource authorizations |
...
| [Azure DevOps Project Permissions](./modules/azuredevops_project_permissions/) | ✅ Completed | [ADOPPv2.0.0](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/ADOPPv2.0.0) | Azure DevOps project permissions module for assigning group permissions |
...
| [Azure DevOps Service Endpoints](./modules/azuredevops_serviceendpoint/) | ✅ Completed | [ADOSEv1.0.0](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/ADOSEv1.0.0) | Azure DevOps service endpoints module for managing a single generic service endpoint and strict-child permissions |
| [Azure DevOps Service Hooks](./modules/azuredevops_servicehooks/) | ✅ Completed | [ADOSHv1.0.0](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/ADOSHv1.0.0) | Azure DevOps service hooks module for managing single webhook subscription (use module-level for_each for multiples) |
| [Azure DevOps Service Principal Entitlement](./modules/azuredevops_service_principal_entitlement/) | ✅ Completed | [ADOSPEv2.0.0](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/ADOSPEv2.0.0) | Azure DevOps module for managing a service principal entitlement |
| [Azure DevOps Team](./modules/azuredevops_team/) | ✅ Completed | [ADOTv1.0.0](https://github.com/PatrykIti/azurerm-terraform-modules/releases/tag/ADOTv1.0.0) | Azure DevOps team module for managing a team, members, and administrators |
