# TASK-040: Azure AI Services Account module (azurerm_ai_services_account)
# FileName: TASK-040_AI_Services_Account_Module.md
...
Stworzyc nowy modul dla `azurerm_ai_services_account` zgodny z:
- `docs/MODULE_GUIDE/`
- `docs/TESTING_GUIDE/`
- `docs/TERRAFORM_BEST_PRACTICES_GUIDE.md`
- `docs/SECURITY.md`

Ten task dotyczy wylacznie resource typu `azurerm_ai_services_account`.
...
na `azurerm_ai_services_account`, to ich wsparcie jest w tym module
...
**Cel:** Potwierdzic pelny zakres funkcji provider `azurerm` dla `azurerm_ai_services_account`.
...
**Checklist:**
- [ ] `modules/azurerm_ai_services_account/` utworzony przez
      `scripts/create-new-module.sh` (wymagane).
- [ ] `module.json`:
  - name: `azurerm_ai_services_account`
...
### TASK-040-3: Core resource `azurerm_ai_services_account`
...
- Modul `azurerm_ai_services_account` spelnia layout z MODULE_GUIDE.
