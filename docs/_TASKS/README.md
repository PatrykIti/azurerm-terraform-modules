# Kanban Tasks - azurerm-terraform-modules
...
|----|-------|----------|--------|-------|
| [TASK-051](./TASK-051_Azure_Managed_Redis_Module.md) | **Azure Managed Redis module (full feature scope)** | High | Large | `modules/azurerm_managed_redis/`; `azurerm_managed_redis` + `azurerm_managed_redis_geo_replication` |
