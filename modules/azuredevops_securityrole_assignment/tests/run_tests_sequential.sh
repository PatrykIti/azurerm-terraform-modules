...
tests=(
    "TestBasicAzuredevopsSecurityroleAssignment"
    "TestCompleteAzuredevopsSecurityroleAssignment"
    "TestSecureAzuredevopsSecurityroleAssignment"
    "TestAzuredevopsSecurityroleAssignmentValidationRules"
    "TestAzuredevopsSecurityroleAssignmentFullIntegration"
)

echo "Starting sequential test execution for azuredevops_securityrole_assignment"
