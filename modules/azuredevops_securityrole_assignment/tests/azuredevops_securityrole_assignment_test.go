...
func TestBasicAzuredevopsSecurityroleAssignment(t *testing.T) {
	...
	defer test_structure.RunTestStage(t, "cleanup", func() {
		terraform.Destroy(t, getTerraformOptions(t, testFolder, getIdentityIDBasic(t)))
	})

	test_structure.RunTestStage(t, "deploy", func() {
		terraformOptions := getTerraformOptions(t, testFolder, getIdentityIDBasic(t))
...
func TestSecureAzuredevopsSecurityroleAssignment(t *testing.T) {
	...
	defer test_structure.RunTestStage(t, "cleanup", func() {
		terraform.Destroy(t, getTerraformOptions(t, testFolder, getIdentityIDSecure(t)))
	})

	test_structure.RunTestStage(t, "deploy", func() {
		terraformOptions := getTerraformOptions(t, testFolder, getIdentityIDSecure(t))
		test_structure.SaveTerraformOptions(t, testFolder, terraformOptions)
		terraform.InitAndApply(t, terraformOptions)
	})
