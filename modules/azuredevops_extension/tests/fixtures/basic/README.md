...
This example demonstrates a basic Azure DevOps Extension configuration using secure defaults and minimal setup.

## Features

- Creates a basic azuredevops_extension with standard configuration
