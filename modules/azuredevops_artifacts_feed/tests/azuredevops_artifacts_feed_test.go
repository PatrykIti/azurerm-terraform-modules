...
func TestBasicAzuredevopsArtifactsFeed(t *testing.T) {
	...
	testFolder := test_structure.CopyTerraformFolderToTemp(t, "../..", "azuredevops_artifacts_feed/tests/fixtures/basic")
...
func TestCompleteAzuredevopsArtifactsFeed(t *testing.T) {
	...
	testFolder := test_structure.CopyTerraformFolderToTemp(t, "../..", "azuredevops_artifacts_feed/tests/fixtures/complete")
	defer test_structure.RunTestStage(t, "cleanup", func() {
		terraform.Destroy(t, getTerraformOptions(t, testFolder))
	})
...
func TestSecureAzuredevopsArtifactsFeed(t *testing.T) {
	...
	testFolder := test_structure.CopyTerraformFolderToTemp(t, "../..", "azuredevops_artifacts_feed/tests/fixtures/secure")
	defer test_structure.RunTestStage(t, "cleanup", func() {
		terraform.Destroy(t, getTerraformOptions(t, testFolder))
	})
