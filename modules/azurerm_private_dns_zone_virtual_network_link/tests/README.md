# Private DNS Zone Virtual Network Link Module Tests

This directory contains automated tests for the Private DNS Zone Virtual Network Link Terraform module using [Terratest](https://terratest.gruntwork.io/).
...
```bash
make test-single TEST_NAME=TestBasicPrivateDnsZoneVirtualNetworkLink
```
...
- `private_dns_zone_virtual_network_link_test.go` - Main module functionality tests
