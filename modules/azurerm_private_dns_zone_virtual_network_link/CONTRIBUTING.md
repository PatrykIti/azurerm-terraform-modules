# Contributing to azurerm_private_dns_zone_virtual_network_link Module
...
6. Commit using conventional commits: `feat(private-dns-zone-vnet-link): add new feature`
...
```bash
feat(private-dns-zone-vnet-link): add support for new feature
fix(private-dns-zone-vnet-link): correct validation logic
docs(private-dns-zone-vnet-link): update README examples
```
