...
tests=(
    "TestBasicAzuredevopsServicehooks"
    "TestCompleteAzuredevopsServicehooks"
    "TestSecureAzuredevopsServicehooks"
    "TestAzuredevopsServicehooksValidationRules"
    "TestAzuredevopsServicehooksFullIntegration"
)

echo "Starting sequential test execution for azuredevops_servicehooks"
