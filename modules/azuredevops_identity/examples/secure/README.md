...
| <a name="input_group_name_prefix"></a> [group\_name\_prefix](#input\_group\_name\_prefix) | Prefix for Azure DevOps group names. | `string` | `"ado-identity-secure"` | no |
| <a name="input_user_principal_name"></a> [user\_principal\_name](#input\_user\_principal\_name) | Optional user principal name for stakeholder entitlement. | `string` | `""` | no |
