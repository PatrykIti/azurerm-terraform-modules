# Azure DevOps Identity Module Tests

This directory contains automated tests for the Azure DevOps Identity Terraform module using [Terratest](https://terratest.gruntwork.io/).
...
- `azuredevops_identity_test.go` - Basic, complete, secure, and validation tests
...
```bash
go test -v -run TestBasicAzuredevopsIdentity
```
