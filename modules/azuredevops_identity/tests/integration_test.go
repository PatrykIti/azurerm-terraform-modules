...
// TestAzuredevopsIdentityFullIntegration tests all features working together
...
// validateCoreFeatures validates basic azuredevops_identity features using SDK
func validateCoreFeatures(t *testing.T, testFolder string) {
	terraformOptions := test_structure.LoadTerraformOptions(t, testFolder)
	helper := Newazuredevops_identityHelper(t)
	...
	// resource := helper.Getazuredevops_identityProperties(t, resourceName, resourceGroupName)
	...
	// TODO: Add azuredevops_identity specific core validations using the SDK
	// Examples:
	...
	// Validateazuredevops_identityTags(t, resource, expectedTags)
}
...
func validateSecurityFeatures(t *testing.T, testFolder string) {
	...
	// TODO: Add azuredevops_identity specific security validations
	// Examples:
	...
	// helper.Validateazuredevops_identityEncryption(t, resource)
}
...
func validateNetworkFeatures(t *testing.T, testFolder string) {
	...
	// Network validations
	// TODO: Add azuredevops_identity specific network validations
	// Examples:
...
func validateOperationalFeatures(t *testing.T, testFolder string) {
	...
	// TODO: Add azuredevops_identity specific operational validations
	// Examples:
...
// TestAzuredevopsIdentityWithNetworkRules tests network access controls
func TestAzuredevopsIdentityWithNetworkRules(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
	t.Parallel()
...
// TestAzuredevopsIdentityPrivateEndpointIntegration tests private endpoint configuration
func TestAzuredevopsIdentityPrivateEndpointIntegration(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
	t.Parallel()
...
// TestAzuredevopsIdentitySecurityConfiguration tests security features
func TestAzuredevopsIdentitySecurityConfiguration(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
	t.Parallel()
...
// TestAzuredevopsIdentityLifecycle tests the complete lifecycle
func TestAzuredevopsIdentityLifecycle(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
	t.Parallel()
	...
	updatedResourceID := terraform.Output(t, terraformOptions, "azuredevops_identity_id")
...
// TestAzuredevopsIdentityCompliance tests compliance-related features
func TestAzuredevopsIdentityCompliance(t *testing.T) {
	t.Parallel()
	...
	complianceChecks := []struct {
		...
		// TODO: Add azuredevops_identity specific compliance checks
		// Examples:
		// {
		//     name:    "HTTPS Only",
