...
// BenchmarkAzuredevopsIdentityCreationSimple benchmarks simple azuredevops_identity creation
func BenchmarkAzuredevopsIdentityCreationSimple(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkAzuredevopsIdentityCreationWithFeatures benchmarks azuredevops_identity with various features
func BenchmarkAzuredevopsIdentityCreationWithFeatures(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkAzuredevopsIdentityCreationWithScale benchmarks with different scale configurations
func BenchmarkAzuredevopsIdentityCreationWithScale(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkAzuredevopsIdentityParallelCreation benchmarks parallel creation of azuredevops_identity
func BenchmarkAzuredevopsIdentityParallelCreation(b *testing.B) {
...
// TestAzuredevopsIdentityCreationTime validates creation time is within acceptable limits
func TestAzuredevopsIdentityCreationTime(t *testing.T) {
	if testing.Short() {
	...
	// azuredevops_identity creation should complete within 5 minutes
	// Adjust this based on the actual expected creation time for the resource
	maxDuration := 5 * time.Minute
	require.LessOrEqual(t, duration, maxDuration,
		"Azure DevOps Identity creation took %v, expected less than %v", duration, maxDuration)

	t.Logf("Azure DevOps Identity created in %v", duration)
}

// TestAzuredevopsIdentityScaling tests creating multiple azuredevops_identity instances
func TestAzuredevopsIdentityScaling(t *testing.T) {
	if testing.Short() {
	...
	for i := 0; i < instanceCount; i++ {
		...
		t.Logf("Azure DevOps Identity instance %d created in %v", i, creationTimes[i])
	}
	...
	t.Logf("Average creation time for %d azuredevops_identity instances: %v", instanceCount, avgTime)
...
// TestAzuredevopsIdentityUpdatePerformance tests update performance
func TestAzuredevopsIdentityUpdatePerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
	...
	updateScenarios := []struct {
		...
		// Add more update scenarios specific to azuredevops_identity
	}
...
// TestAzuredevopsIdentityDestroyPerformance tests destroy performance
func TestAzuredevopsIdentityDestroyPerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
	...
	t.Logf("Azure DevOps Identity destroyed in %v", destroyTime)
