# Contributing to azuredevops_elastic_pool Module
...
6. Commit using conventional commits: `feat(azuredevops-elastic-pool): add new feature`
...
```bash
feat(azuredevops-elastic-pool): add support for new feature
fix(azuredevops-elastic-pool): correct validation logic
docs(azuredevops-elastic-pool): update README examples
```
