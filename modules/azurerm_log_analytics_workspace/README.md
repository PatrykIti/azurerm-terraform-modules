...
| <a name="input_local_authentication_disabled"></a> [local\_authentication\_disabled](#input\_local\_authentication\_disabled) | Whether local (workspace key) authentication is disabled. | `bool` | `false` | no |
