# Log Analytics Cluster Example

This example provisions a Log Analytics cluster alongside the workspace.
...
| <a name="input_workspace_name"></a> [workspace\_name](#input\_workspace\_name) | Log Analytics Workspace name. | `string` | `"law-cluster-example"` | no |

## Outputs

| Name | Description |
|------|-------------|
| <a name="output_clusters"></a> [clusters](#output\_clusters) | Clusters created by the module. |
<!-- END_TF_DOCS -->