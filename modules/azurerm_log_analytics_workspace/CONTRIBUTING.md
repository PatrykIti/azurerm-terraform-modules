# Contributing to azurerm_log_analytics_workspace Module
...
6. Commit using conventional commits: `feat(log-analytics-workspace): add new feature`
...
```bash
feat(log-analytics-workspace): add support for new feature
fix(log-analytics-workspace): correct validation logic
docs(log-analytics-workspace): update README examples
```
