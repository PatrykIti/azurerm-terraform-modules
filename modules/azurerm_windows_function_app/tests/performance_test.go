...
// BenchmarkWindowsFunctionAppCreationSimple benchmarks simple windows_function_app creation
func BenchmarkWindowsFunctionAppCreationSimple(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkWindowsFunctionAppCreationWithFeatures benchmarks windows_function_app with various features
func BenchmarkWindowsFunctionAppCreationWithFeatures(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkWindowsFunctionAppCreationWithScale benchmarks with different scale configurations
func BenchmarkWindowsFunctionAppCreationWithScale(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkWindowsFunctionAppParallelCreation benchmarks parallel creation of windows_function_app
func BenchmarkWindowsFunctionAppParallelCreation(b *testing.B) {
...
// TestWindowsFunctionAppCreationTime validates creation time is within acceptable limits
func TestWindowsFunctionAppCreationTime(t *testing.T) {
	if testing.Short() {
	...
	// windows_function_app creation should complete within 5 minutes
	// Adjust this based on the actual expected creation time for the resource
	maxDuration := 5 * time.Minute
	require.LessOrEqual(t, duration, maxDuration,
		"Windows Function App creation took %v, expected less than %v", duration, maxDuration)

	t.Logf("Windows Function App created in %v", duration)
}

// TestWindowsFunctionAppScaling tests creating multiple windows_function_app instances
func TestWindowsFunctionAppScaling(t *testing.T) {
	if testing.Short() {
	...
	for i := 0; i < instanceCount; i++ {
		...
		t.Logf("Windows Function App instance %d created in %v", i, creationTimes[i])
	}
	...
	t.Logf("Average creation time for %d windows_function_app instances: %v", instanceCount, avgTime)
...
func TestWindowsFunctionAppUpdatePerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
...
// TestWindowsFunctionAppDestroyPerformance tests destroy performance
func TestWindowsFunctionAppDestroyPerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
