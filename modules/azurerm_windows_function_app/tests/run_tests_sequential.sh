...
tests=(
    "TestBasicWindowsFunctionApp"
    "TestCompleteWindowsFunctionApp"
    "TestSecureWindowsFunctionApp"
    "TestNetworkWindowsFunctionApp"
    "TestWindowsFunctionAppPrivateEndpoint"
    "TestWindowsFunctionAppValidationRules"
    "TestWindowsFunctionAppFullIntegration"
    "TestWindowsFunctionAppLifecycle"
    "TestWindowsFunctionAppCreationTime"
    "BenchmarkWindowsFunctionAppCreation"
)

echo "Starting sequential test execution for azurerm_windows_function_app"
