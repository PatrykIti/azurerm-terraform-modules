# Basic Windows Function App Example

This example demonstrates a basic Windows Function App configuration using secure defaults and minimal setup.

## Features

- Creates a basic windows_function_app with standard configuration
