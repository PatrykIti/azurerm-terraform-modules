# Secure Windows Function App Example

This example demonstrates a maximum-security Windows Function App configuration suitable for highly sensitive data and regulated environments.
