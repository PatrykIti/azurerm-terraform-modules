# Contributing to azurerm_windows_function_app Module
...
6. Commit using conventional commits: `feat(windows-function-app): add new feature`
...
```bash
feat(windows-function-app): add support for new feature
fix(windows-function-app): correct validation logic
docs(windows-function-app): update README examples
```
