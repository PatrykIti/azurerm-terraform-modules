# Contributing to azurerm_private_dns_zone Module
...
6. Commit using conventional commits: `feat(private-dns-zone): add new feature`
...
```bash
feat(private-dns-zone): add support for new feature
fix(private-dns-zone): correct validation logic
docs(private-dns-zone): update README examples
```
