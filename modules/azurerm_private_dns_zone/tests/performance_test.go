...
// BenchmarkPrivateDnsZoneCreationSimple benchmarks simple private_dns_zone creation
func BenchmarkPrivateDnsZoneCreationSimple(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkPrivateDnsZoneCreationWithFeatures benchmarks private_dns_zone with various features
func BenchmarkPrivateDnsZoneCreationWithFeatures(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkPrivateDnsZoneCreationWithScale benchmarks with different scale configurations
func BenchmarkPrivateDnsZoneCreationWithScale(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkPrivateDnsZoneParallelCreation benchmarks parallel creation of private_dns_zone
func BenchmarkPrivateDnsZoneParallelCreation(b *testing.B) {
...
// TestPrivateDnsZoneCreationTime validates creation time is within acceptable limits
func TestPrivateDnsZoneCreationTime(t *testing.T) {
	if testing.Short() {
	...
	// private_dns_zone creation should complete within 5 minutes
	// Adjust this based on the actual expected creation time for the resource
	maxDuration := 5 * time.Minute
	require.LessOrEqual(t, duration, maxDuration,
		"Private DNS Zone creation took %v, expected less than %v", duration, maxDuration)

	t.Logf("Private DNS Zone created in %v", duration)
}

// TestPrivateDnsZoneScaling tests creating multiple private_dns_zone instances
func TestPrivateDnsZoneScaling(t *testing.T) {
	if testing.Short() {
	...
	for i := 0; i < instanceCount; i++ {
		...
		t.Logf("Private DNS Zone instance %d created in %v", i, creationTimes[i])
	}
	...
	t.Logf("Average creation time for %d private_dns_zone instances: %v", instanceCount, avgTime)
...
// TestPrivateDnsZoneUpdatePerformance tests update performance
func TestPrivateDnsZoneUpdatePerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
...
// TestPrivateDnsZoneDestroyPerformance tests destroy performance
func TestPrivateDnsZoneDestroyPerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
	...
	t.Logf("Private DNS Zone destroyed in %v", destroyTime)
