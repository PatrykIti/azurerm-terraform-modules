# Basic Private DNS Zone Example

This example demonstrates a basic Private DNS Zone configuration using secure defaults and minimal setup.

## Features

- Creates a basic private_dns_zone with standard configuration
