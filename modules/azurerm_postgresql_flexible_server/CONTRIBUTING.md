# Contributing to azurerm_postgresql_flexible_server Module
...
6. Commit using conventional commits: `feat(postgresql-flexible-server): add new feature`
...
```bash
feat(postgresql-flexible-server): add support for new feature
fix(postgresql-flexible-server): correct validation logic
docs(postgresql-flexible-server): update README examples
```
