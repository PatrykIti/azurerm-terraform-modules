...
// TestPostgresqlFlexibleServerFullIntegration tests all features working together
...
// validateCoreFeatures validates basic postgresql_flexible_server features using SDK
func validateCoreFeatures(t *testing.T, testFolder string) {
	terraformOptions := test_structure.LoadTerraformOptions(t, testFolder)
	helper := Newpostgresql_flexible_serverHelper(t)
	...
	// resource := helper.Getpostgresql_flexible_serverProperties(t, resourceName, resourceGroupName)
	...
	// TODO: Add postgresql_flexible_server specific core validations using the SDK
	// Examples:
	...
	// Validatepostgresql_flexible_serverTags(t, resource, expectedTags)
}
...
func validateSecurityFeatures(t *testing.T, testFolder string) {
	...
	// TODO: Add postgresql_flexible_server specific security validations
	// Examples:
	...
	// helper.Validatepostgresql_flexible_serverEncryption(t, resource)
}
...
func validateNetworkFeatures(t *testing.T, testFolder string) {
	...
	// Network validations
	// TODO: Add postgresql_flexible_server specific network validations
	// Examples:
...
func validateOperationalFeatures(t *testing.T, testFolder string) {
	...
	// TODO: Add postgresql_flexible_server specific operational validations
	// Examples:
...
// TestPostgresqlFlexibleServerWithNetworkRules tests network access controls
...
// TestPostgresqlFlexibleServerPrivateEndpointIntegration tests private endpoint configuration
...
// TestPostgresqlFlexibleServerSecurityConfiguration tests security features
...
// TestPostgresqlFlexibleServerLifecycle tests the complete lifecycle
...
// TestPostgresqlFlexibleServerCompliance tests compliance-related features
func TestPostgresqlFlexibleServerCompliance(t *testing.T) {
	...
	complianceChecks := []struct {
		...
		// TODO: Add postgresql_flexible_server specific compliance checks
		// Examples:
		// {
		//     name:    "HTTPS Only",
