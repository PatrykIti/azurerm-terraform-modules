# PostgreSQL Flexible Server Module Tests

This directory contains automated tests for the PostgreSQL Flexible Server Terraform module using [Terratest](https://terratest.gruntwork.io/).
