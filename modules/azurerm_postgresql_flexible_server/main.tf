# Azure PostgreSQL Flexible Server Module - Initial Release
...
resource "azurerm_postgresql_flexible_server_network_rules" "main" {
  count = var.network_rules != null ? 1 : 0

  # TODO: Configure network rules based on resource type
  # storage_account_id = azurerm_postgresql_flexible_server.main.id
