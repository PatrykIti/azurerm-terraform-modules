# Contributing to azurerm_linux_virtual_machine Module
...
6. Commit using conventional commits: `feat(linux-virtual-machine): add new feature`
...
```bash
feat(linux-virtual-machine): add support for new feature
fix(linux-virtual-machine): correct validation logic
docs(linux-virtual-machine): update README examples
```
