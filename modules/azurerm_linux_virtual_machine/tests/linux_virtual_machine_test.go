...
// Test basic Linux VM creation
func TestBasicLinuxVirtualMachine(t *testing.T) {
	if testing.Short() {
...
// Test secure Linux VM configuration
func TestSecureLinuxVirtualMachine(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
	t.Parallel()
...
func TestLinuxVirtualMachineDataDisks(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
	t.Parallel()
...
func TestLinuxVirtualMachineExtensions(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
	t.Parallel()
