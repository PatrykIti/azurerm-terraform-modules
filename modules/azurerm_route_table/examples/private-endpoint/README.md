# Private Endpoint Route Table Example

This example demonstrates a Route Table configuration with private endpoint connectivity for enhanced security and network isolation.

## Features

- Creates a route_table with private endpoint access
...
- Private endpoint connection to the route_table
