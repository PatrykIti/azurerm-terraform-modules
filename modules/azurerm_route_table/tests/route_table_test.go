...
// Test basic route_table creation
func TestBasicRoute Table(t *testing.T) {
	t.Parallel()
	...
	test_structure.RunTestStage(t, "validate", func() {
		...
		// Add route_table specific validations here
	})
}

// Test complete route_table with all features
func TestCompleteRoute Table(t *testing.T) {
	t.Parallel()
...
func TestRoute TableSecurity(t *testing.T) {
	t.Parallel()

	testFolder := test_structure.CopyTerraformFolderToTemp(t, "../..", "azurerm_route_table/tests/fixtures/security")
	defer test_structure.RunTestStage(t, "cleanup", func() {
		terraform.Destroy(t, getTerraformOptions(t, testFolder))
	})
...
func TestRoute TableNetworkRules(t *testing.T) {
	t.Parallel()
...
func TestRoute TableValidationRules(t *testing.T) {
	...
	testCases := []struct {
		...
		// Add more validation test cases specific to route_table
	}
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			testFolder := test_structure.CopyTerraformFolderToTemp(t, "../..", fmt.Sprintf("azurerm_route_table/tests/fixtures/%s", tc.fixtureFile))
