# Contributing to azurerm_linux_function_app Module
...
6. Commit using conventional commits: `feat(linux-function-app): add new feature`
...
```bash
feat(linux-function-app): add support for new feature
fix(linux-function-app): correct validation logic
docs(linux-function-app): update README examples
```
