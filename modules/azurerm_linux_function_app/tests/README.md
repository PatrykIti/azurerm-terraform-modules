# Linux Function App Module Tests

This directory contains automated tests for the Linux Function App Terraform module using [Terratest](https://terratest.gruntwork.io/).
