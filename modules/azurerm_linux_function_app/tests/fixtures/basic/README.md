...
This example demonstrates a basic Linux Function App configuration using secure defaults and minimal setup.

## Features

- Creates a basic linux_function_app with standard configuration
