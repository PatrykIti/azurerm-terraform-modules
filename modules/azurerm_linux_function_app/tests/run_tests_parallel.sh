...
tests=(
    ...
    "TestLinuxFunctionAppWithNetworkRules"
    "TestLinuxFunctionAppPrivateEndpointIntegration"
    "TestLinuxFunctionAppSecurityConfiguration"
    "TestLinuxFunctionAppLifecycle"
    "TestLinuxFunctionAppCompliance"
    "TestLinuxFunctionAppCreationTime"
    "TestLinuxFunctionAppScaling"
    "TestLinuxFunctionAppUpdatePerformance"
    "TestLinuxFunctionAppDestroyPerformance"
)

echo "Starting parallel test execution for azurerm_linux_function_app"
