# Contributing to azurerm_cognitive_account Module
...
6. Commit using conventional commits: `feat(cognitive-account): add new feature`
...
```bash
feat(cognitive-account): add support for new feature
fix(cognitive-account): correct validation logic
docs(cognitive-account): update README examples
```
