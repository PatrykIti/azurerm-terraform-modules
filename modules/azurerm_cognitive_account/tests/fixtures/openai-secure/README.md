# Secure Cognitive Account Example

This example demonstrates a maximum-security Cognitive Account configuration suitable for highly sensitive data and regulated environments.
