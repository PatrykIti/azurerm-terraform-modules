# Basic Cognitive Account Example

This example demonstrates a basic Cognitive Account configuration using secure defaults and minimal setup.

## Features

- Creates a basic cognitive_account with standard configuration
