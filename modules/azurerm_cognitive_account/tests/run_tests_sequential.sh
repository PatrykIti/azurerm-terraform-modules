...
tests=(
    "TestBasicCognitiveAccount"
    "TestCompleteCognitiveAccount"
    "TestSecureCognitiveAccount"
    "TestNetworkCognitiveAccount"
    "TestCognitiveAccountPrivateEndpoint"
    "TestCognitiveAccountValidationRules"
    "TestCognitiveAccountFullIntegration"
    "TestCognitiveAccountLifecycle"
    "TestCognitiveAccountCreationTime"
    "BenchmarkCognitiveAccountCreation"
)

echo "Starting sequential test execution for azurerm_cognitive_account"
