...
```hcl
import {
  to = azurerm_cognitive_account_rai_policy.cognitive_account_rai_policy["policy-name"]
...
```hcl
import {
  to = azurerm_cognitive_account_rai_blocklist.cognitive_account_rai_blocklist["blocklist-name"]
...
```hcl
import {
  to = azurerm_cognitive_account_customer_managed_key.cognitive_account_customer_managed_key[0]
  id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/example-rg/providers/Microsoft.CognitiveServices/accounts/example-account"
}
```
