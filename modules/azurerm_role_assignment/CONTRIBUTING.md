# Contributing to azurerm_role_assignment Module
...
6. Commit using conventional commits: `feat(role-assignment): add new feature`
...
```bash
feat(role-assignment): add support for new feature
fix(role-assignment): correct validation logic
docs(role-assignment): update README examples
```
