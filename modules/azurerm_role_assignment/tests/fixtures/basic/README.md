# Basic Role Assignment Example

This example demonstrates a basic Role Assignment configuration using secure defaults and minimal setup.

## Features

- Creates a basic role_assignment with standard configuration
