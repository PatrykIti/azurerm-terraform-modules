# Role Assignment Module Tests

This directory contains automated tests for the Role Assignment Terraform module using [Terratest](https://terratest.gruntwork.io/).
