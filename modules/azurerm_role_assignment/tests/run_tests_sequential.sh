...
tests=(
    "TestBasicRoleAssignment"
    "TestCompleteRoleAssignment"
    "TestSecureRoleAssignment"
    "TestNetworkRoleAssignment"
    "TestRoleAssignmentPrivateEndpoint"
    "TestRoleAssignmentValidationRules"
    "TestRoleAssignmentFullIntegration"
    "TestRoleAssignmentLifecycle"
    "TestRoleAssignmentCreationTime"
    "BenchmarkRoleAssignmentCreation"
)

echo "Starting sequential test execution for azurerm_role_assignment"
