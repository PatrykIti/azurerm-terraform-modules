# Contributing to azurerm_windows_virtual_machine Module
...
6. Commit using conventional commits: `feat(windows-virtual-machine): add new feature`
...
```bash
feat(windows-virtual-machine): add support for new feature
fix(windows-virtual-machine): correct validation logic
docs(windows-virtual-machine): update README examples
```
