# Basic Windows Virtual Machine Example

This example demonstrates a basic Windows Virtual Machine configuration using secure defaults and minimal setup.

## Features

- Creates a basic windows_virtual_machine with standard configuration
