# Contributing to azuredevops_group_entitlement Module
...
6. Commit using conventional commits: `feat(azuredevops-group-entitlement): add new feature`
...
```bash
feat(azuredevops-group-entitlement): add support for new feature
fix(azuredevops-group-entitlement): correct validation logic
docs(azuredevops-group-entitlement): update README examples
```
