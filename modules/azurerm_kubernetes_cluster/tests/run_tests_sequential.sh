...
tests=(
    "TestBasicKubernetesCluster"
    "TestCompleteKubernetesCluster"
    "TestSecureKubernetesCluster"
    "TestKubernetesClusterValidationRules"
    "TestKubernetesClusterLifecycle"
    "TestKubernetesClusterCreationTime"
    "BenchmarkKubernetesClusterCreation"
)

echo "Starting sequential test execution for azurerm_kubernetes_cluster"
