# Basic Kubernetes Cluster Example

This example demonstrates a basic Kubernetes Cluster configuration using secure defaults and minimal setup.

## Features

- Creates a basic kubernetes_cluster with standard configuration
