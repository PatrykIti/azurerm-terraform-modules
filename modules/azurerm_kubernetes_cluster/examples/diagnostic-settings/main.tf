...
# This example enables control plane diagnostics to Log Analytics.
...
module "kubernetes_cluster" {
  source = "github.com/PatrykIti/azurerm-terraform-modules//modules/azurerm_kubernetes_cluster?ref=AKSv2.1.0"
