/**
 * Semantic Release Configuration for Virtual Network Module
 */
...
All notable changes to the Azure Virtual Network Terraform module will be documented in this file.
...
and this project adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.html).`
    ...
    ['@semantic-release/exec', {
      prepareCmd: `
        ...
        if [[ -x "./scripts/update-root-readme.sh" ]]; then
          ./scripts/update-root-readme.sh "${MODULE_NAME}" "Virtual Network" "${TAG_PREFIX}" "\${nextRelease.version}" "PatrykIti" "azurerm-terraform-modules"
        fi
      `.trim()
    }],
    ...
    ['@semantic-release/git', {
      assets: [
        'modules/azurerm_virtual_network/CHANGELOG.md',
        'modules/azurerm_virtual_network/.github/module-config.yml',
        'modules/azurerm_virtual_network/examples/**/*.tf',
        'modules/azurerm_virtual_network/README.md',
        'README.md'
      ],
      message: `chore(virtual-network): release ${TAG_PREFIX}\${nextRelease.version} [skip ci]`
    }],
    ...
    ['@semantic-release/github', {
      ...
      failComment: false,
      labels: ['release', 'module:virtual-network'],
      releaseBodyTemplate: `## Azure Virtual Network Module v\${nextRelease.version}
