# Contributing to azurerm_monitor_data_collection_rule Module
...
6. Commit using conventional commits: `feat(monitor-dcr): add new feature`
...
```bash
feat(monitor-dcr): add support for new feature
fix(monitor-dcr): correct validation logic
docs(monitor-dcr): update README examples
```
