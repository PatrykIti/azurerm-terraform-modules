...
tests=(
    "TestBasicMonitorDataCollectionRule"
    "TestCompleteMonitorDataCollectionRule"
    "TestSecureMonitorDataCollectionRule"
    "TestMonitorDataCollectionRuleValidationRules"
    "TestMonitorDataCollectionRuleFullIntegration"
    "TestMonitorDataCollectionRuleSecurityConfiguration"
    "TestMonitorDataCollectionRuleCreationTime"
    "BenchmarkMonitorDataCollectionRuleCreation"
)

echo "Starting sequential test execution for azurerm_monitor_data_collection_rule"
