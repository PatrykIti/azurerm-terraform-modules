# Basic Monitor Data Collection Rule Example

This example demonstrates a basic Monitor Data Collection Rule configuration using secure defaults and minimal setup.

## Features

- Creates a basic monitor_data_collection_rule with standard configuration
