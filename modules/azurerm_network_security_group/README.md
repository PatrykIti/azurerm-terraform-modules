...
- [Complete](examples/complete) - This example demonstrates a comprehensive deployment with advanced rules and diagnostics.
...
- **Observability** - Use diagnostic settings for monitoring and auditing
