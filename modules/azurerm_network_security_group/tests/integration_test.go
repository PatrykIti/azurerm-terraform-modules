...
// TestNetwork Security GroupFullIntegration tests all features working together
func TestNetwork Security GroupFullIntegration(t *testing.T) {
	if testing.Short() {
...
// validateCoreFeatures validates basic network_security_group features using SDK
func validateCoreFeatures(t *testing.T, testFolder string) {
	terraformOptions := test_structure.LoadTerraformOptions(t, testFolder)
	helper := Newnetwork_security_groupHelper(t)
	...
	// resource := helper.Getnetwork_security_groupProperties(t, resourceName, resourceGroupName)
	...
	// TODO: Add network_security_group specific core validations using the SDK
	// Examples:
	...
	// Validatenetwork_security_groupTags(t, resource, expectedTags)
}
...
func validateSecurityFeatures(t *testing.T, testFolder string) {
	...
	// TODO: Add network_security_group specific security validations
	// Examples:
	...
	// helper.Validatenetwork_security_groupEncryption(t, resource)
}
...
func validateNetworkFeatures(t *testing.T, testFolder string) {
	...
	// Network validations
	// TODO: Add network_security_group specific network validations
	// Examples:
...
func validateOperationalFeatures(t *testing.T, testFolder string) {
	...
	// TODO: Add network_security_group specific operational validations
	// Examples:
...
// TestNetwork Security GroupWithNetworkRules tests network access controls
func TestNetwork Security GroupWithNetworkRules(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
	t.Parallel()
...
// TestNetwork Security GroupPrivateEndpoint tests private endpoint configuration
...
// TestNetwork Security GroupSecurityConfiguration tests security features
func TestNetwork Security GroupSecurityConfiguration(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
	t.Parallel()
...
// TestNetwork Security GroupValidationRules tests the module's input validation rules
func TestNetwork Security GroupValidationRules(t *testing.T) {
	...
	testCases := []struct {
		...
		//     fixturePath:   "azurerm_network_security_group/tests/fixtures/negative/invalid_name_short",
		//     expectError:   true,
		//     errorContains: "name must be at least 3 characters",
		// },
		// {
		//     name:          "InvalidNameTooLong",
		//     fixturePath:   "azurerm_network_security_group/tests/fixtures/negative/invalid_name_long",
		//     expectError:   true,
		//     errorContains: "name must be at most 24 characters",
		// },
		// {
		//     name:          "InvalidNameCharacters",
		//     fixturePath:   "azurerm_network_security_group/tests/fixtures/negative/invalid_name_chars",
		//     expectError:   true,
...
// TestNetwork Security GroupLifecycle tests the complete lifecycle
func TestNetwork Security GroupLifecycle(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
	t.Parallel()
	...
	updatedResourceID := terraform.Output(t, terraformOptions, "network_security_group_id")
...
// TestNetwork Security GroupCompliance tests compliance-related features
func TestNetwork Security GroupCompliance(t *testing.T) {
	t.Parallel()
	...
	complianceChecks := []struct {
		...
		// TODO: Add network_security_group specific compliance checks
		// Examples:
		// {
		//     name:    "HTTPS Only",
...
// BenchmarkNetwork Security GroupCreation benchmarks resource creation
func BenchmarkNetwork Security GroupCreation(b *testing.B) {
	...
	testFolder := test_structure.CopyTerraformFolderToTemp(b, "../..", "azurerm_network_security_group/tests/fixtures/basic")
