...
tests=(
    "TestBasicMonitorDataCollectionEndpoint"
    "TestCompleteMonitorDataCollectionEndpoint"
    "TestSecureMonitorDataCollectionEndpoint"
    "TestMonitorDataCollectionEndpointValidationRules"
    "TestMonitorDataCollectionEndpointFullIntegration"
    "TestMonitorDataCollectionEndpointSecurityConfiguration"
    "TestMonitorDataCollectionEndpointCreationTime"
    "BenchmarkMonitorDataCollectionEndpointCreation"
)

echo "Starting sequential test execution for azurerm_monitor_data_collection_endpoint"
