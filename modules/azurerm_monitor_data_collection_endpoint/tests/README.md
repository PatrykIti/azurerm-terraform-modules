# Monitor Data Collection Endpoint Module Tests

This directory contains automated tests for the Monitor Data Collection Endpoint Terraform module using [Terratest](https://terratest.gruntwork.io/).
...
```bash
go test -v -run TestBasicMonitorDataCollectionEndpoint -timeout 30m
```
...
- `monitor_data_collection_endpoint_test.go` - Main module functionality tests
