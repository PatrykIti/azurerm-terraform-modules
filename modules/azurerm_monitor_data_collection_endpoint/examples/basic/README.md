# Basic Monitor Data Collection Endpoint Example

This example demonstrates a basic Monitor Data Collection Endpoint configuration using secure defaults and minimal setup.

## Features

- Creates a basic monitor_data_collection_endpoint with standard configuration
