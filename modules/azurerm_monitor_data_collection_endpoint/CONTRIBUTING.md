# Contributing to azurerm_monitor_data_collection_endpoint Module
...
6. Commit using conventional commits: `feat(monitor-dce): add new feature`
...
```bash
feat(monitor-dce): add support for new feature
fix(monitor-dce): correct validation logic
docs(monitor-dce): update README examples
```
