# Contributing to kubernetes_cluster_role Module
...
6. Commit using conventional commits: `feat(kubernetes-cluster-role): add new feature`
...
```bash
feat(kubernetes-cluster-role): add support for new feature
fix(kubernetes-cluster-role): correct validation logic
docs(kubernetes-cluster-role): update README examples
```
