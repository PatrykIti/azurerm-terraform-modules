...
This document details the security features and configurations available in the kubernetes_cluster_role Terraform module. The module implements comprehensive security controls following Azure best practices.
...
module "kubernetes_cluster_role" {
  source = "./modules/kubernetes_cluster_role"
