# Basic Kubernetes Cluster Role Example

This example demonstrates a basic Kubernetes Cluster Role configuration using secure defaults and minimal setup.

## Features

- Creates a basic kubernetes_cluster_role with standard configuration
