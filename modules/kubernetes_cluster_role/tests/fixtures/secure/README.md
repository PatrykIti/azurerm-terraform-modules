# Secure Kubernetes Cluster Role Example

This example demonstrates a maximum-security Kubernetes Cluster Role configuration suitable for highly sensitive data and regulated environments.
