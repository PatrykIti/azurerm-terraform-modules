...
tests=(
    "TestBasicKubernetesClusterRole"
    "TestCompleteKubernetesClusterRole"
    "TestSecureKubernetesClusterRole"
    "TestNetworkKubernetesClusterRole"
    "TestKubernetesClusterRolePrivateEndpoint"
    "TestKubernetesClusterRoleValidationRules"
    "TestKubernetesClusterRoleFullIntegration"
    "TestKubernetesClusterRoleLifecycle"
    "TestKubernetesClusterRoleCreationTime"
    "BenchmarkKubernetesClusterRoleCreation"
)

echo "Starting sequential test execution for kubernetes_cluster_role"
