...
// BenchmarkKubernetesClusterRoleCreationSimple benchmarks simple kubernetes_cluster_role creation
func BenchmarkKubernetesClusterRoleCreationSimple(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkKubernetesClusterRoleCreationWithFeatures benchmarks kubernetes_cluster_role with various features
func BenchmarkKubernetesClusterRoleCreationWithFeatures(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkKubernetesClusterRoleCreationWithScale benchmarks with different scale configurations
func BenchmarkKubernetesClusterRoleCreationWithScale(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkKubernetesClusterRoleParallelCreation benchmarks parallel creation of kubernetes_cluster_role
func BenchmarkKubernetesClusterRoleParallelCreation(b *testing.B) {
...
// TestKubernetesClusterRoleCreationTime validates creation time is within acceptable limits
func TestKubernetesClusterRoleCreationTime(t *testing.T) {
	if testing.Short() {
	...
	// kubernetes_cluster_role creation should complete within 5 minutes
	// Adjust this based on the actual expected creation time for the resource
	maxDuration := 5 * time.Minute
	require.LessOrEqual(t, duration, maxDuration,
		"Kubernetes Cluster Role creation took %v, expected less than %v", duration, maxDuration)

	t.Logf("Kubernetes Cluster Role created in %v", duration)
}

// TestKubernetesClusterRoleScaling tests creating multiple kubernetes_cluster_role instances
func TestKubernetesClusterRoleScaling(t *testing.T) {
	if testing.Short() {
	...
	for i := 0; i < instanceCount; i++ {
		...
		t.Logf("Kubernetes Cluster Role instance %d created in %v", i, creationTimes[i])
	}
	...
	t.Logf("Average creation time for %d kubernetes_cluster_role instances: %v", instanceCount, avgTime)
...
// TestKubernetesClusterRoleUpdatePerformance tests update performance
func TestKubernetesClusterRoleUpdatePerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
	...
	updateScenarios := []struct {
		...
		// Add more update scenarios specific to kubernetes_cluster_role
	}
...
// TestKubernetesClusterRoleDestroyPerformance tests destroy performance
func TestKubernetesClusterRoleDestroyPerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
	...
	t.Logf("Kubernetes Cluster Role destroyed in %v", destroyTime)
