# Kubernetes Cluster Role Module Tests

This directory contains automated tests for the Kubernetes Cluster Role Terraform module using [Terratest](https://terratest.gruntwork.io/).
