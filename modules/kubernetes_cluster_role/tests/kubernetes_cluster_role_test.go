...
// Test basic kubernetes_cluster_role creation
func TestBasicKubernetesClusterRole(t *testing.T) {
	...
	test_structure.RunTestStage(t, "validate", func() {
		...
		// Add kubernetes_cluster_role specific validations here
	})
}

// Test complete kubernetes_cluster_role with all features
...
func TestNetworkKubernetesClusterRole(t *testing.T) {
	t.Parallel()
...
func TestKubernetesClusterRolePrivateEndpoint(t *testing.T) {
	t.Parallel()
...
func TestKubernetesClusterRoleValidationRules(t *testing.T) {
	...
	testCases := []struct {
		...
		// Add more validation test cases specific to kubernetes_cluster_role
	}
