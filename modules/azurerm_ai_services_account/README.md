# Terraform Azure AI Services Account Module
...
Manages Azure AI Services Accounts using the `azurerm_ai_services` resource.

## Usage

```hcl
module "azurerm_ai_services_account" {
  source = "path/to/azurerm_ai_services_account"

  # Required variables
  name                = "example-azurerm_ai_services_account"
