...
|------|-------------|------|---------|:--------:|
| <a name="input_ai_services_account_name"></a> [ai\_services\_account\_name](#input\_ai\_services\_account\_name) | The name of the AI Services Account. | `string` | `"aiservicesbasic001"` | no |
