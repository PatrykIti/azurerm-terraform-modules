# Contributing to azurerm_ai_services_account Module
...
6. Commit using conventional commits: `feat(ai-services-account): add new feature`
...
```bash
feat(ai-services-account): add support for new feature
fix(ai-services-account): correct validation logic
docs(ai-services-account): update README examples
```
