...
This example demonstrates a basic AI Services Account configuration using secure defaults and minimal setup.

## Features

- Creates a basic ai_services_account with standard configuration
