# AI Services Account Module Tests

This directory contains automated tests for the AI Services Account Terraform module using [Terratest](https://terratest.gruntwork.io/).
...
```bash
go test -v -run TestBasicAiServicesAccount -timeout 30m
```
...
- `ai_services_account_test.go` - Main module functionality tests
