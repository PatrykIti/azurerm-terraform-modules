...
tests=(
    "TestBasicAiServicesAccount"
    "TestCompleteAiServicesAccount"
    "TestSecureAiServicesAccount"
    "TestNetworkAiServicesAccount"
    "TestAiServicesAccountPrivateEndpoint"
    "TestAiServicesAccountValidationRules"
    "TestAiServicesAccountFullIntegration"
    "TestAiServicesAccountLifecycle"
    "TestAiServicesAccountCreationTime"
    "BenchmarkAiServicesAccountCreation"
)

echo "Starting sequential test execution for azurerm_ai_services_account"
