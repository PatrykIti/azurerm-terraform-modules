...
This document details the security features and configurations available in the kubernetes_cluster_role_binding Terraform module. The module implements comprehensive security controls following Azure best practices.
...
module "kubernetes_cluster_role_binding" {
  source = "./modules/kubernetes_cluster_role_binding"
