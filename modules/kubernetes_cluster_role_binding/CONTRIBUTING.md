# Contributing to kubernetes_cluster_role_binding Module
...
6. Commit using conventional commits: `feat(kubernetes-cluster-role-binding): add new feature`
...
```bash
feat(kubernetes-cluster-role-binding): add support for new feature
fix(kubernetes-cluster-role-binding): correct validation logic
docs(kubernetes-cluster-role-binding): update README examples
```
