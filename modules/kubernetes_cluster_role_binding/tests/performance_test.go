...
// BenchmarkKubernetesClusterRoleBindingCreationSimple benchmarks simple kubernetes_cluster_role_binding creation
func BenchmarkKubernetesClusterRoleBindingCreationSimple(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkKubernetesClusterRoleBindingCreationWithFeatures benchmarks kubernetes_cluster_role_binding with various features
func BenchmarkKubernetesClusterRoleBindingCreationWithFeatures(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkKubernetesClusterRoleBindingCreationWithScale benchmarks with different scale configurations
func BenchmarkKubernetesClusterRoleBindingCreationWithScale(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkKubernetesClusterRoleBindingParallelCreation benchmarks parallel creation of kubernetes_cluster_role_binding
func BenchmarkKubernetesClusterRoleBindingParallelCreation(b *testing.B) {
...
// TestKubernetesClusterRoleBindingCreationTime validates creation time is within acceptable limits
func TestKubernetesClusterRoleBindingCreationTime(t *testing.T) {
	...
	// kubernetes_cluster_role_binding creation should complete within 5 minutes
	// Adjust this based on the actual expected creation time for the resource
	maxDuration := 5 * time.Minute
	require.LessOrEqual(t, duration, maxDuration,
		"Kubernetes Cluster Role Binding creation took %v, expected less than %v", duration, maxDuration)

	t.Logf("Kubernetes Cluster Role Binding created in %v", duration)
}

// TestKubernetesClusterRoleBindingScaling tests creating multiple kubernetes_cluster_role_binding instances
func TestKubernetesClusterRoleBindingScaling(t *testing.T) {
	if testing.Short() {
	...
	for i := 0; i < instanceCount; i++ {
		...
		t.Logf("Kubernetes Cluster Role Binding instance %d created in %v", i, creationTimes[i])
	}
	...
	t.Logf("Average creation time for %d kubernetes_cluster_role_binding instances: %v", instanceCount, avgTime)
...
// TestKubernetesClusterRoleBindingUpdatePerformance tests update performance
func TestKubernetesClusterRoleBindingUpdatePerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
	...
	updateScenarios := []struct {
		...
		// Add more update scenarios specific to kubernetes_cluster_role_binding
	}
...
// TestKubernetesClusterRoleBindingDestroyPerformance tests destroy performance
func TestKubernetesClusterRoleBindingDestroyPerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
	...
	t.Logf("Kubernetes Cluster Role Binding destroyed in %v", destroyTime)
