# Kubernetes Cluster Role Binding Module Tests

This directory contains automated tests for the Kubernetes Cluster Role Binding Terraform module using [Terratest](https://terratest.gruntwork.io/).
