# Azure DevOps Group Module Tests

This directory contains automated tests for the Azure DevOps Group Terraform module using [Terratest](https://terratest.gruntwork.io/).

## Prerequisites

1. **Go**: Version 1.21 or later
2. **Terraform**: Version 1.7.5 or later
...
- `azuredevops_group_test.go` - Basic, complete, secure, and validation tests
...
```bash
go test -v -run TestBasicAzuredevopsGroup
```
