...
tests=(
    "TestBasicAzuredevopsGroup"
    "TestCompleteAzuredevopsGroup"
    "TestSecureAzuredevopsGroup"
    "TestAzuredevopsGroupValidationRules"
    "TestAzuredevopsGroupFullIntegration"
)

echo "Starting sequential test execution for azuredevops_group"
