...
output "database_charset" {
  description = "The charset configured for the database."
  value       = module.postgresql_flexible_server_database.charset
}

output "database_collation" {
  description = "The collation configured for the database."
  value       = module.postgresql_flexible_server_database.collation
}
