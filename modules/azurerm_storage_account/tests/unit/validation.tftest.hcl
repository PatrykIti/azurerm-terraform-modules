...
# Monitoring validation: missing Event Hub name
...
# Monitoring validation: invalid destination type
...
# Monitoring validation: per-scope limit exceeded
run "monitoring_scope_limit_exceeded" {
  command = plan
  ...
  variables {
    ...
    monitoring = {
      storage_account = [
        { name = "ds-1", log_categories = ["StorageRead"], log_analytics_workspace_id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.OperationalInsights/workspaces/test-law" },
        { name = "ds-2", log_categories = ["StorageRead"], log_analytics_workspace_id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.OperationalInsights/workspaces/test-law" },
        { name = "ds-3", log_categories = ["StorageRead"], log_analytics_workspace_id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.OperationalInsights/workspaces/test-law" },
        { name = "ds-4", log_categories = ["StorageRead"], log_analytics_workspace_id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.OperationalInsights/workspaces/test-law" },
        { name = "ds-5", log_categories = ["StorageRead"], log_analytics_workspace_id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.OperationalInsights/workspaces/test-law" },
        { name = "ds-6", log_categories = ["StorageRead"], log_analytics_workspace_id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.OperationalInsights/workspaces/test-law" }
      ]
    }
  }
