...
tests=(
    "TestBasicBastionHost"
    "TestCompleteBastionHost"
    "TestSecureBastionHost"
    "TestBastionHostIPConnect"
    "TestBastionHostTunneling"
    "TestBastionHostShareableLink"
    "TestBastionHostFileCopy"
    "TestBastionHostDiagnosticSettings"
    "TestBastionHostValidationRules"
    "TestBastionHostFullIntegration"
    "TestBastionHostLifecycle"
    "TestBastionHostCreationTime"
)

echo "Starting sequential test execution for azurerm_bastion_host"
