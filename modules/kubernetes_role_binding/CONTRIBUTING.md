# Contributing to kubernetes_role_binding Module
...
6. Commit using conventional commits: `feat(kubernetes-role-binding): add new feature`
...
```bash
feat(kubernetes-role-binding): add support for new feature
fix(kubernetes-role-binding): correct validation logic
docs(kubernetes-role-binding): update README examples
```
