# Basic Kubernetes Role Binding Example

This example demonstrates a basic Kubernetes Role Binding configuration using secure defaults and minimal setup.

## Features

- Creates a basic kubernetes_role_binding with standard configuration
