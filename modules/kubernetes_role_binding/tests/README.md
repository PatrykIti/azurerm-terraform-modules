# Kubernetes Role Binding Module Tests

This directory contains automated tests for the Kubernetes Role Binding Terraform module using [Terratest](https://terratest.gruntwork.io/).
