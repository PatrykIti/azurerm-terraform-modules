...
tests=(
    "TestBasicKubernetesRoleBinding"
    "TestCompleteKubernetesRoleBinding"
    "TestSecureKubernetesRoleBinding"
    "TestNetworkKubernetesRoleBinding"
    "TestKubernetesRoleBindingPrivateEndpoint"
    "TestKubernetesRoleBindingValidationRules"
    "TestKubernetesRoleBindingFullIntegration"
    "TestKubernetesRoleBindingLifecycle"
    "TestKubernetesRoleBindingCreationTime"
    "BenchmarkKubernetesRoleBindingCreation"
)

echo "Starting sequential test execution for kubernetes_role_binding"
