...
// BenchmarkKubernetesRoleBindingCreationSimple benchmarks simple kubernetes_role_binding creation
func BenchmarkKubernetesRoleBindingCreationSimple(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkKubernetesRoleBindingCreationWithFeatures benchmarks kubernetes_role_binding with various features
func BenchmarkKubernetesRoleBindingCreationWithFeatures(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkKubernetesRoleBindingCreationWithScale benchmarks with different scale configurations
func BenchmarkKubernetesRoleBindingCreationWithScale(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkKubernetesRoleBindingParallelCreation benchmarks parallel creation of kubernetes_role_binding
func BenchmarkKubernetesRoleBindingParallelCreation(b *testing.B) {
...
// TestKubernetesRoleBindingCreationTime validates creation time is within acceptable limits
func TestKubernetesRoleBindingCreationTime(t *testing.T) {
	if testing.Short() {
	...
	// kubernetes_role_binding creation should complete within 5 minutes
	// Adjust this based on the actual expected creation time for the resource
	maxDuration := 5 * time.Minute
	require.LessOrEqual(t, duration, maxDuration,
		"Kubernetes Role Binding creation took %v, expected less than %v", duration, maxDuration)

	t.Logf("Kubernetes Role Binding created in %v", duration)
}

// TestKubernetesRoleBindingScaling tests creating multiple kubernetes_role_binding instances
func TestKubernetesRoleBindingScaling(t *testing.T) {
	if testing.Short() {
	...
	for i := 0; i < instanceCount; i++ {
		...
		t.Logf("Kubernetes Role Binding instance %d created in %v", i, creationTimes[i])
	}
	...
	t.Logf("Average creation time for %d kubernetes_role_binding instances: %v", instanceCount, avgTime)
...
// TestKubernetesRoleBindingUpdatePerformance tests update performance
func TestKubernetesRoleBindingUpdatePerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
	...
	updateScenarios := []struct {
		...
		// Add more update scenarios specific to kubernetes_role_binding
	}
...
// TestKubernetesRoleBindingDestroyPerformance tests destroy performance
func TestKubernetesRoleBindingDestroyPerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
	...
	t.Logf("Kubernetes Role Binding destroyed in %v", destroyTime)
