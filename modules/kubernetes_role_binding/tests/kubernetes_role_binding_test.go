...
func TestBasicKubernetesRoleBinding(t *testing.T) {
	...
	test_structure.RunTestStage(t, "validate", func() {
		...
		count := terraform.Output(t, terraformOptions, "subject_count")
...
func TestCompleteKubernetesRoleBinding(t *testing.T) {
	...
	testFolder := test_structure.CopyTerraformFolderToTemp(t, "../..", "kubernetes_role_binding/tests/fixtures/complete")
	defer test_structure.RunTestStage(t, "cleanup", func() {
		terraformOptions := test_structure.LoadTerraformOptions(t, testFolder)
		terraform.Destroy(t, terraformOptions)
	})
...
func TestSecureKubernetesRoleBinding(t *testing.T) {
	...
	testFolder := test_structure.CopyTerraformFolderToTemp(t, "../..", "kubernetes_role_binding/tests/fixtures/secure")
	defer test_structure.RunTestStage(t, "cleanup", func() {
		terraformOptions := test_structure.LoadTerraformOptions(t, testFolder)
		terraform.Destroy(t, terraformOptions)
	})
...
func TestKubernetesRoleBindingValidationRules(t *testing.T) {
	...
	testFolder := test_structure.CopyTerraformFolderToTemp(t, "../..", "kubernetes_role_binding/tests/fixtures/negative")
...
func BenchmarkKubernetesRoleBindingCreation(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		b.StopTimer()
		testFolder := test_structure.CopyTerraformFolderToTemp(b, "../..", "kubernetes_role_binding/tests/fixtures/basic")
