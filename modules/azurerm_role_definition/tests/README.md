# Role Definition Module Tests

This directory contains automated tests for the Role Definition Terraform module using [Terratest](https://terratest.gruntwork.io/).
