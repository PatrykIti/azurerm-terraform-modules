...
tests=(
    "TestBasicRoleDefinition"
    "TestCompleteRoleDefinition"
    "TestSecureRoleDefinition"
    "TestNetworkRoleDefinition"
    "TestRoleDefinitionPrivateEndpoint"
    "TestRoleDefinitionValidationRules"
    "TestRoleDefinitionFullIntegration"
    "TestRoleDefinitionLifecycle"
    "TestRoleDefinitionCreationTime"
    "BenchmarkRoleDefinitionCreation"
)

echo "Starting sequential test execution for azurerm_role_definition"
