...
This example demonstrates a basic Role Definition configuration using secure defaults and minimal setup.

## Features

- Creates a basic role_definition with standard configuration
