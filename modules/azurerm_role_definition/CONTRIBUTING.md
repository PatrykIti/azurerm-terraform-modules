# Contributing to azurerm_role_definition Module
...
6. Commit using conventional commits: `feat(role-definition): add new feature`
...
```bash
feat(role-definition): add support for new feature
fix(role-definition): correct validation logic
docs(role-definition): update README examples
```
