# Kubernetes Role Module Tests

This directory contains automated tests for the Kubernetes Role Terraform module using [Terratest](https://terratest.gruntwork.io/).
