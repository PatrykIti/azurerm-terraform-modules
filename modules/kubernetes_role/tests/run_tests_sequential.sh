...
tests=(
    "TestBasicKubernetesRole"
    "TestCompleteKubernetesRole"
    "TestSecureKubernetesRole"
    "TestNetworkKubernetesRole"
    "TestKubernetesRolePrivateEndpoint"
    "TestKubernetesRoleValidationRules"
    "TestKubernetesRoleFullIntegration"
    "TestKubernetesRoleLifecycle"
    "TestKubernetesRoleCreationTime"
    "BenchmarkKubernetesRoleCreation"
)

echo "Starting sequential test execution for kubernetes_role"
