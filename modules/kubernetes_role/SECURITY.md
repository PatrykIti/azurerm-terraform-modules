...
This document details the security features and configurations available in the kubernetes_role Terraform module. The module implements comprehensive security controls following Azure best practices.
...
module "kubernetes_role" {
  source = "./modules/kubernetes_role"
