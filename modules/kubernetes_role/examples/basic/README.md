# Basic Kubernetes Role Example

This example demonstrates a basic Kubernetes Role configuration using secure defaults and minimal setup.

## Features

- Creates a basic kubernetes_role with standard configuration
