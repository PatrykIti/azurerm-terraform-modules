# Contributing to kubernetes_role Module
...
6. Commit using conventional commits: `feat(kubernetes-role): add new feature`
...
```bash
feat(kubernetes-role): add support for new feature
fix(kubernetes-role): correct validation logic
docs(kubernetes-role): update README examples
```
