...
This example demonstrates a basic Key Vault configuration using secure defaults and minimal setup.

## Features

- Creates a basic key_vault with standard configuration
