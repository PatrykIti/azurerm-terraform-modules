...
tests=(
    "TestBasicKeyVault"
    "TestCompleteKeyVault"
    "TestSecureKeyVault"
    "TestNetworkKeyVault"
    "TestKeyVaultValidationRules"
    "TestKeyVaultCompleteIntegration"
    "TestKeyVaultLifecycle"
    "TestKeyVaultCreationTime"
)

echo "Starting sequential test execution for azurerm_key_vault"
