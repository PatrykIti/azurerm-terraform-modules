...
This example enables RBAC authorization and assigns the Key Vault Secrets Officer role
outside the module.
...
| [azurerm_role_definition.secrets_officer](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/role_definition) | data source |
