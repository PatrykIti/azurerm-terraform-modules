# Contributing to azurerm_key_vault Module
...
6. Commit using conventional commits: `feat(key-vault): add new feature`
...
```bash
feat(key-vault): add support for new feature
fix(key-vault): correct validation logic
docs(key-vault): update README examples
```
