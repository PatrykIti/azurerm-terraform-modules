# Contributing to azurerm_application_insights_workbook Module
...
6. Commit using conventional commits: `feat(application-insights-workbook): add new feature`
...
```bash
feat(application-insights-workbook): add support for new feature
fix(application-insights-workbook): correct validation logic
docs(application-insights-workbook): update README examples
```
