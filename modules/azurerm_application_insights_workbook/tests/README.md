...
This directory contains automated tests for the Application Insights Workbook Terraform module using [Terratest](https://terratest.gruntwork.io/).
...
- `fixtures/workbook-identity/` - Identity-focused configuration
