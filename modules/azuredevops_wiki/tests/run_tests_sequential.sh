...
tests=(
    "TestBasicAzuredevopsWiki"
    "TestCompleteAzuredevopsWiki"
    "TestSecureAzuredevopsWiki"
    "TestAzuredevopsWikiValidationRules"
    "TestAzuredevopsWikiFullIntegration"
)

echo "Starting sequential test execution for azuredevops_wiki"
