...
This module manages Azure DevOps azure devops project permissions resources and related configuration.
...
- Use `git::https://...//modules/azuredevops_project_permissions?ref=ADOPPvX.Y.Z` for module source.
