# Contributing to kubernetes_namespace Module
...
6. Commit using conventional commits: `feat(kubernetes-namespace): add new feature`
...
```bash
feat(kubernetes-namespace): add support for new feature
fix(kubernetes-namespace): correct validation logic
docs(kubernetes-namespace): update README examples
```
