# Basic Kubernetes Namespace Example

This example demonstrates a basic Kubernetes Namespace configuration using secure defaults and minimal setup.

## Features

- Creates a basic kubernetes_namespace with standard configuration
