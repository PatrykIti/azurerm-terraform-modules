...
tests=(
    "TestBasicKubernetesNamespace"
    "TestCompleteKubernetesNamespace"
    "TestSecureKubernetesNamespace"
    "TestNetworkKubernetesNamespace"
    "TestKubernetesNamespacePrivateEndpoint"
    "TestKubernetesNamespaceValidationRules"
    "TestKubernetesNamespaceFullIntegration"
    "TestKubernetesNamespaceLifecycle"
    "TestKubernetesNamespaceCreationTime"
    "BenchmarkKubernetesNamespaceCreation"
)

echo "Starting sequential test execution for kubernetes_namespace"
