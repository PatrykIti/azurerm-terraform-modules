...
// BenchmarkKubernetesNamespaceCreationSimple benchmarks simple kubernetes_namespace creation
func BenchmarkKubernetesNamespaceCreationSimple(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkKubernetesNamespaceCreationWithFeatures benchmarks kubernetes_namespace with various features
func BenchmarkKubernetesNamespaceCreationWithFeatures(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkKubernetesNamespaceCreationWithScale benchmarks with different scale configurations
func BenchmarkKubernetesNamespaceCreationWithScale(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkKubernetesNamespaceParallelCreation benchmarks parallel creation of kubernetes_namespace
func BenchmarkKubernetesNamespaceParallelCreation(b *testing.B) {
...
// TestKubernetesNamespaceCreationTime validates creation time is within acceptable limits
func TestKubernetesNamespaceCreationTime(t *testing.T) {
	...
	// kubernetes_namespace creation should complete within 5 minutes
	// Adjust this based on the actual expected creation time for the resource
	maxDuration := 5 * time.Minute
	require.LessOrEqual(t, duration, maxDuration,
		"Kubernetes Namespace creation took %v, expected less than %v", duration, maxDuration)

	t.Logf("Kubernetes Namespace created in %v", duration)
}

// TestKubernetesNamespaceScaling tests creating multiple kubernetes_namespace instances
func TestKubernetesNamespaceScaling(t *testing.T) {
	if testing.Short() {
	...
	for i := 0; i < instanceCount; i++ {
		...
		t.Logf("Kubernetes Namespace instance %d created in %v", i, creationTimes[i])
	}
	...
	t.Logf("Average creation time for %d kubernetes_namespace instances: %v", instanceCount, avgTime)
...
// TestKubernetesNamespaceUpdatePerformance tests update performance
func TestKubernetesNamespaceUpdatePerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
	...
	updateScenarios := []struct {
		...
		// Add more update scenarios specific to kubernetes_namespace
	}
...
// TestKubernetesNamespaceDestroyPerformance tests destroy performance
func TestKubernetesNamespaceDestroyPerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
	...
	t.Logf("Kubernetes Namespace destroyed in %v", destroyTime)
