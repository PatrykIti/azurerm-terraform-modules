...
// Test basic kubernetes_namespace creation
func TestBasicKubernetesNamespace(t *testing.T) {
	...
	test_structure.RunTestStage(t, "validate", func() {
		...
		// Add kubernetes_namespace specific validations here
	})
}

// Test complete kubernetes_namespace with all features
...
func TestNetworkKubernetesNamespace(t *testing.T) {
	t.Parallel()
...
func TestKubernetesNamespacePrivateEndpoint(t *testing.T) {
	t.Parallel()
...
func TestKubernetesNamespaceValidationRules(t *testing.T) {
	...
	testCases := []struct {
		...
		// Add more validation test cases specific to kubernetes_namespace
	}
