...
This example demonstrates a basic Managed Redis configuration using secure defaults and minimal setup.

## Features

- Creates a basic managed_redis with standard configuration
