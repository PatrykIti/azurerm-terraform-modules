...
tests=(
    "TestBasicManagedRedis"
    "TestCompleteManagedRedis"
    "TestSecureManagedRedis"
    "TestNetworkManagedRedis"
    "TestManagedRedisPrivateEndpoint"
    "TestManagedRedisValidationRules"
    "TestManagedRedisFullIntegration"
    "TestManagedRedisLifecycle"
    "TestManagedRedisCreationTime"
    "BenchmarkManagedRedisCreation"
)

echo "Starting parallel test execution for azurerm_managed_redis"
