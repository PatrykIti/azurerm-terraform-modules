# Contributing to azurerm_managed_redis Module
...
6. Commit using conventional commits: `feat(managed-redis): add new feature`
...
```bash
feat(managed-redis): add support for new feature
fix(managed-redis): correct validation logic
docs(managed-redis): update README examples
```
