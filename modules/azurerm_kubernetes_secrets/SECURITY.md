...
This document details the security features and configurations available in the azurerm_kubernetes_secrets Terraform module. The module implements comprehensive security controls following Azure best practices.
...
module "kubernetes_secrets" {
  source = "./modules/azurerm_kubernetes_secrets"
