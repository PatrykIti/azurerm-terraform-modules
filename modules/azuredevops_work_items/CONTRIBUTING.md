# Contributing to azuredevops_work_items Module
...
6. Commit using conventional commits: `feat(azuredevops-work-items): add new feature`
...
```bash
feat(azuredevops-work-items): add support for new feature
fix(azuredevops-work-items): correct validation logic
docs(azuredevops-work-items): update README examples
```
