...
tests=(
    "TestBasicAzuredevopsWorkItems"
    "TestCompleteAzuredevopsWorkItems"
    "TestSecureAzuredevopsWorkItems"
    "TestAzuredevopsWorkItemsValidationRules"
    "TestAzuredevopsWorkItemsFullIntegration"
)

echo "Starting sequential test execution for azuredevops_work_items"
