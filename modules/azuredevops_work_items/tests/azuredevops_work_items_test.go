...
func TestBasicAzuredevopsWorkItems(t *testing.T) {
	...
	testFolder := test_structure.CopyTerraformFolderToTemp(t, "../..", "azuredevops_work_items/tests/fixtures/basic")
...
func TestCompleteAzuredevopsWorkItems(t *testing.T) {
	...
	testFolder := test_structure.CopyTerraformFolderToTemp(t, "../..", "azuredevops_work_items/tests/fixtures/complete")
	defer test_structure.RunTestStage(t, "cleanup", func() {
		terraform.Destroy(t, getTerraformOptions(t, testFolder))
	})
...
func TestSecureAzuredevopsWorkItems(t *testing.T) {
	...
	testFolder := test_structure.CopyTerraformFolderToTemp(t, "../..", "azuredevops_work_items/tests/fixtures/secure")
	defer test_structure.RunTestStage(t, "cleanup", func() {
		terraform.Destroy(t, getTerraformOptions(t, testFolder))
	})
...
func TestAzuredevopsWorkItemsValidationRules(t *testing.T) {
	...
	testFolder := test_structure.CopyTerraformFolderToTemp(t, "../..", "azuredevops_work_items/tests/fixtures/negative")
