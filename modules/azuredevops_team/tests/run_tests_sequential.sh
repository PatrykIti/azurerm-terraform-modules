...
tests=(
    "TestBasicAzuredevopsTeam"
    "TestCompleteAzuredevopsTeam"
    "TestSecureAzuredevopsTeam"
    "TestAzuredevopsTeamValidationRules"
    "TestAzuredevopsTeamFullIntegration"
)

echo "Starting sequential test execution for azuredevops_team"
