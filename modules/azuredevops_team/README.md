...
|------|-------------|------|---------|:--------:|
| <a name="input_project_id"></a> [project\_id](#input\_project\_id) | Azure DevOps project ID where teams will be created. | `string` | n/a | yes |
| <a name="input_team_administrators"></a> [team\_administrators](#input\_team\_administrators) | List of team administrator assignments. | <pre>list(object({<br/>    key               = optional(string)<br/>    team_id           = optional(string)<br/>    team_key          = optional(string)<br/>    admin_descriptors = list(string)<br/>    mode              = optional(string, "add")<br/>  }))</pre> | `[]` | no |
| <a name="input_team_members"></a> [team\_members](#input\_team\_members) | List of team membership assignments. | <pre>list(object({<br/>    key                = optional(string)<br/>    team_id            = optional(string)<br/>    team_key           = optional(string)<br/>    member_descriptors = list(string)<br/>    mode               = optional(string, "add")<br/>  }))</pre> | `[]` | no |
| <a name="input_teams"></a> [teams](#input\_teams) | Map of Azure DevOps teams to manage. | <pre>map(object({<br/>    name        = optional(string)<br/>    description = optional(string)<br/>  }))</pre> | `{}` | no |
