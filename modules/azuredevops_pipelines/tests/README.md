...
4. **Azure DevOps Project**: Project ID for pipeline creation
...
```bash
go test -v -run TestBasicAzuredevopsPipelines -timeout 30m
```
...
3. **Resource Conflicts**: Ensure unique pipeline naming
