...
6. Commit using conventional commits: `feat(azuredevops-pipelines): add new feature`
...
```bash
feat(azuredevops-pipelines): add support for new feature
fix(azuredevops-pipelines): correct validation logic
docs(azuredevops-pipelines): update README examples
```
