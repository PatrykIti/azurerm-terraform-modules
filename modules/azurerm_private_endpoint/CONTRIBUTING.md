# Contributing to azurerm_private_endpoint Module
...
6. Commit using conventional commits: `feat(private-endpoint): add new feature`
...
```bash
feat(private-endpoint): add support for new feature
fix(private-endpoint): correct validation logic
docs(private-endpoint): update README examples
```
