# Basic PostgreSQL Flexible Server Database Example

This example demonstrates a basic PostgreSQL Flexible Server Database configuration using secure defaults and minimal setup.

## Features

- Creates a basic postgresql_flexible_server_database with standard configuration
...
| <a name="input_database_name"></a> [database\_name](#input\_database\_name) | PostgreSQL database name. | `string` | `"appdbbasic"` | no |
...
| <a name="input_resource_group_name"></a> [resource\_group\_name](#input\_resource\_group\_name) | Name of the resource group for the example. | `string` | `"rg-pgfsdb-basic-example"` | no |
| <a name="input_server_name"></a> [server\_name](#input\_server\_name) | PostgreSQL Flexible Server name (must be globally unique). | `string` | `"pgfsdbbasicexample001"` | no |
