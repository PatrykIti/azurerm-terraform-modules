# Contributing to azurerm_postgresql_flexible_server_database Module
...
6. Commit using conventional commits: `feat(postgresql-flexible-server-database): add new feature`
...
```bash
feat(postgresql-flexible-server-database): add support for new feature
fix(postgresql-flexible-server-database): correct validation logic
docs(postgresql-flexible-server-database): update README examples
```
