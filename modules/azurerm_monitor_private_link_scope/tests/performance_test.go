...
// BenchmarkMonitorPrivateLinkScopeCreationSimple benchmarks simple monitor_private_link_scope creation
func BenchmarkMonitorPrivateLinkScopeCreationSimple(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkMonitorPrivateLinkScopeCreationWithFeatures benchmarks monitor_private_link_scope with various features
func BenchmarkMonitorPrivateLinkScopeCreationWithFeatures(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkMonitorPrivateLinkScopeCreationWithScale benchmarks with different scale configurations
func BenchmarkMonitorPrivateLinkScopeCreationWithScale(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkMonitorPrivateLinkScopeParallelCreation benchmarks parallel creation of monitor_private_link_scope
func BenchmarkMonitorPrivateLinkScopeParallelCreation(b *testing.B) {
...
// TestMonitorPrivateLinkScopeCreationTime validates creation time is within acceptable limits
func TestMonitorPrivateLinkScopeCreationTime(t *testing.T) {
	if testing.Short() {
	...
	// monitor_private_link_scope creation should complete within 5 minutes
	// Adjust this based on the actual expected creation time for the resource
	maxDuration := 5 * time.Minute
	require.LessOrEqual(t, duration, maxDuration,
		"Monitor Private Link Scope creation took %v, expected less than %v", duration, maxDuration)

	t.Logf("Monitor Private Link Scope created in %v", duration)
}

// TestMonitorPrivateLinkScopeScaling tests creating multiple monitor_private_link_scope instances
func TestMonitorPrivateLinkScopeScaling(t *testing.T) {
	if testing.Short() {
	...
	for i := 0; i < instanceCount; i++ {
		...
		t.Logf("Monitor Private Link Scope instance %d created in %v", i, creationTimes[i])
	}
	...
	t.Logf("Average creation time for %d monitor_private_link_scope instances: %v", instanceCount, avgTime)
...
// TestMonitorPrivateLinkScopeUpdatePerformance tests update performance
func TestMonitorPrivateLinkScopeUpdatePerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
...
// TestMonitorPrivateLinkScopeDestroyPerformance tests destroy performance
func TestMonitorPrivateLinkScopeDestroyPerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
	...
	t.Logf("Monitor Private Link Scope destroyed in %v", destroyTime)
