# Basic Monitor Private Link Scope Example

This example demonstrates a basic Monitor Private Link Scope configuration using secure defaults and minimal setup.

## Features

- Creates a basic monitor_private_link_scope with standard configuration
