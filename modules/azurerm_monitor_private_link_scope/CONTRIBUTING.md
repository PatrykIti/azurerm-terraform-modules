# Contributing to azurerm_monitor_private_link_scope Module
...
6. Commit using conventional commits: `feat(monitor-private-link-scope): add new feature`
...
```bash
feat(monitor-private-link-scope): add support for new feature
fix(monitor-private-link-scope): correct validation logic
docs(monitor-private-link-scope): update README examples
```
