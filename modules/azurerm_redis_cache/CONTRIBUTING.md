# Contributing to azurerm_redis_cache Module
...
6. Commit using conventional commits: `feat(redis-cache): add new feature`
...
```bash
feat(redis-cache): add support for new feature
fix(redis-cache): correct validation logic
docs(redis-cache): update README examples
```
