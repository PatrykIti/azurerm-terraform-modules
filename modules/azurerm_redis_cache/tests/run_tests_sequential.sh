...
tests=(
    "TestBasicRedisCache"
    "TestCompleteRedisCache"
    "TestSecureRedisCache"
    "TestRedisCachePatchSchedule"
    "TestRedisCacheFirewallRules"
    "TestRedisCacheLinkedServer"
    "TestRedisCacheFullIntegration"
    "TestRedisCacheLifecycle"
    "TestRedisCacheCreationTime"
)

echo "Starting sequential test execution for azurerm_redis_cache"
