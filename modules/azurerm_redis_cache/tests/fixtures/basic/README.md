...
This example demonstrates a basic Redis Cache configuration using secure defaults and minimal setup.

## Features

- Creates a basic redis_cache with standard configuration
