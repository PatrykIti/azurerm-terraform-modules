# VNet Injection Redis Cache Example

This example demonstrates deploying a Premium Redis Cache using VNet injection
with public network access disabled.

## Features

- Premium SKU cache in a dedicated subnet.
- Public network access disabled.
- Static private IP address assigned.
...
| <a name="input_redis_cache_name"></a> [redis\_cache\_name](#input\_redis\_cache\_name) | The name of the Redis Cache. | `string` | `"redis-vnet-example"` | no |
| <a name="input_resource_group_name"></a> [resource\_group\_name](#input\_resource\_group\_name) | The name of the resource group. | `string` | `"rg-redis-vnet-example"` | no |
| <a name="input_virtual_network_name"></a> [virtual\_network\_name](#input\_virtual\_network\_name) | The name of the virtual network. | `string` | `"vnet-redis-vnet-example"` | no |
