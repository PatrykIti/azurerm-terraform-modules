# Firewall Rules Redis Cache Example

This example demonstrates enabling public access with firewall rules to restrict
allowed IP ranges.

## Features

- Standard SKU cache with public access.
- Firewall rules for explicit IP ranges.
...
| <a name="input_redis_cache_name"></a> [redis\_cache\_name](#input\_redis\_cache\_name) | The name of the Redis Cache. | `string` | `"redis-firewall-example"` | no |
| <a name="input_resource_group_name"></a> [resource\_group\_name](#input\_resource\_group\_name) | The name of the resource group. | `string` | `"rg-redis-firewall-example"` | no |
