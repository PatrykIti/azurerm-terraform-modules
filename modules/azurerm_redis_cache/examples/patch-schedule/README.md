# Patch Schedule Redis Cache Example

This example demonstrates configuring a patch schedule for a Premium Redis Cache.
...
| <a name="input_redis_cache_name"></a> [redis\_cache\_name](#input\_redis\_cache\_name) | The name of the Redis Cache. | `string` | `"redis-patch-example"` | no |
| <a name="input_resource_group_name"></a> [resource\_group\_name](#input\_resource\_group\_name) | The name of the resource group. | `string` | `"rg-redis-patch-example"` | no |
