# Contributing to azurerm_ai_services Module
...
6. Commit using conventional commits: `feat(ai-services): add new feature`
...
```bash
feat(ai-services): add support for new feature
fix(ai-services): correct validation logic
docs(ai-services): update README examples
```
