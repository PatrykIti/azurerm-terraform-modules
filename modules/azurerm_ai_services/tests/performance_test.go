...
// BenchmarkAiServicesCreationSimple benchmarks simple AI Services Account creation.
func BenchmarkAiServicesCreationSimple(b *testing.B) {
	b.ReportAllocs()
...
// TestAiServicesCreationTime validates creation time is within an acceptable limit.
func TestAiServicesCreationTime(t *testing.T) {
	if testing.Short() {
