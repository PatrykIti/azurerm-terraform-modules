...
This directory contains automated tests for the AI Services Terraform module using [Terratest](https://terratest.gruntwork.io/).
...
```bash
go test -v -run TestBasicAiServices -timeout 30m
```
...
- `ai_services_test.go` - Main module functionality tests
