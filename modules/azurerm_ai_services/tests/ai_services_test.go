...
// Test basic ai_services creation
func TestBasicAiServices(t *testing.T) {
	t.Parallel()
	...
	test_structure.RunTestStage(t, "validate", func() {
		...
		// Get outputs
		resourceID := terraform.Output(t, terraformOptions, "ai_services_id")
		resourceName := terraform.Output(t, terraformOptions, "ai_services_name")
		...
		// Add ai_services specific validations here
	})
}

// Test complete ai_services with all features
func TestCompleteAiServices(t *testing.T) {
	t.Parallel()
...
func TestSecureAiServices(t *testing.T) {
	t.Parallel()
...
func TestNetworkAiServices(t *testing.T) {
	t.Parallel()
...
func TestAiServicesValidationRules(t *testing.T) {
	t.Parallel()
	...
	testCases := []struct {
		...
		// Add more validation test cases specific to ai_services
	}
...
func BenchmarkAiServicesCreation(b *testing.B) {
