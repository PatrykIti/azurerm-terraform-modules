...
tests=(
    "TestBasicAiServices"
    "TestCompleteAiServices"
    "TestSecureAiServices"
    "TestNetworkAiServices"
    "TestAiServicesPrivateEndpoint"
    "TestAiServicesValidationRules"
    "TestAiServicesFullIntegration"
    "TestAiServicesLifecycle"
    "TestAiServicesCreationTime"
    "BenchmarkAiServicesCreation"
)

echo "Starting sequential test execution for azurerm_ai_services"
