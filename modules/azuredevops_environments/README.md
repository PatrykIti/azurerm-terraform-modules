...
| Name | Description |
|------|-------------|
| <a name="output_check_ids"></a> [check\_ids](#output\_check\_ids) | Map of check IDs grouped by check type and keyed by check key. |
| <a name="output_environment_id"></a> [environment\_id](#output\_environment\_id) | ID of the environment managed by this module. |
| <a name="output_kubernetes_resource_ids"></a> [kubernetes\_resource\_ids](#output\_kubernetes\_resource\_ids) | Map of Kubernetes resource IDs keyed by resource key/name. |
<!-- END_TF_DOCS -->
