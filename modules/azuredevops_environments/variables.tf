...
# -----------------------------------------------------------------------------
# Kubernetes Resources + Kubernetes-level Checks
# -----------------------------------------------------------------------------

variable "kubernetes_resources" {
  description = "List of Kubernetes resources attached to the environment. Optional checks can be nested under checks and target the backing service endpoint."
  type = list(object({
    name                = string
  ...
  validation {
    ...
    error_message = "kubernetes_resources.checks.approvals names must be unique per kubernetes resource."
  }
  ...
  validation {
    ...
    error_message = "kubernetes_resources.checks.branch_controls names must be unique per kubernetes resource."
  }
  ...
  validation {
    ...
    error_message = "kubernetes_resources.checks.business_hours names must be unique per kubernetes resource."
  }
  ...
  validation {
    ...
    error_message = "kubernetes_resources.checks.exclusive_locks names must be unique per kubernetes resource."
  }
  ...
  validation {
    ...
    error_message = "kubernetes_resources.checks.required_templates names must be unique per kubernetes resource."
  }
  ...
  validation {
    ...
    error_message = "kubernetes_resources.checks.rest_apis names must be unique per kubernetes resource."
  }
