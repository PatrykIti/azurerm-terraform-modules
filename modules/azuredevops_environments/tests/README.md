# Azure DevOps Environments Module Tests

This directory contains automated tests for the Azure DevOps Environments Terraform module using [Terratest](https://terratest.gruntwork.io/).
...
- `azuredevops_environments_test.go` - Basic, complete, secure, and validation tests
