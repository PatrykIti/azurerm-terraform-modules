...
This example demonstrates a basic Azure DevOps Agent Pools configuration using secure defaults and minimal setup.

## Features

- Creates a basic azuredevops_agent_pools with standard configuration
