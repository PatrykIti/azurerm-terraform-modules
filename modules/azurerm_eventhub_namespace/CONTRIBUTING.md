# Contributing to azurerm_eventhub_namespace Module
...
6. Commit using conventional commits: `feat(eventhub-namespace): add new feature`
...
```bash
feat(eventhub-namespace): add support for new feature
fix(eventhub-namespace): correct validation logic
docs(eventhub-namespace): update README examples
```
