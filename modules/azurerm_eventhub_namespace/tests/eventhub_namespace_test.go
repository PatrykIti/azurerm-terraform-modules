...
// Test basic eventhub_namespace creation
func TestBasicEventhubNamespace(t *testing.T) {
	t.Parallel()
	...
	test_structure.RunTestStage(t, "validate", func() {
		...
		// Add eventhub_namespace specific validations here
	})
}

// Test complete eventhub_namespace with all features
func TestCompleteEventhubNamespace(t *testing.T) {
	t.Parallel()
...
func TestSecureEventhubNamespace(t *testing.T) {
	t.Parallel()
...
func TestNetworkEventhubNamespace(t *testing.T) {
	t.Parallel()
...
func TestEventhubNamespaceValidationRules(t *testing.T) {
	t.Parallel()
	...
	testCases := []struct {
		...
		// Add more validation test cases specific to eventhub_namespace
	}
...
func BenchmarkEventhubNamespaceCreation(b *testing.B) {
