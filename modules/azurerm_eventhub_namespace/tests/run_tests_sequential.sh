...
tests=(
    "TestBasicEventhubNamespace"
    "TestCompleteEventhubNamespace"
    "TestSecureEventhubNamespace"
    "TestNetworkEventhubNamespace"
    "TestEventhubNamespacePrivateEndpoint"
    "TestEventhubNamespaceValidationRules"
    "TestEventhubNamespaceFullIntegration"
    "TestEventhubNamespaceLifecycle"
    "TestEventhubNamespaceCreationTime"
    "BenchmarkEventhubNamespaceCreation"
)

echo "Starting sequential test execution for azurerm_eventhub_namespace"
