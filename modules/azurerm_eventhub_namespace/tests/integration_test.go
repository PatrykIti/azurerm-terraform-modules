...
// TestEventhubNamespaceFullIntegration tests all features working together
func TestEventhubNamespaceFullIntegration(t *testing.T) {
	if testing.Short() {
...
func validateSecurityFeatures(t *testing.T, testFolder string) {
	...
	// TODO: Add eventhub_namespace specific security validations
	// Examples:
...
func validateNetworkFeatures(t *testing.T, testFolder string) {
	...
	// Network validations
	// TODO: Add eventhub_namespace specific network validations
	// Examples:
...
// TestEventhubNamespaceWithNetworkRules tests network access controls
func TestEventhubNamespaceWithNetworkRules(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
	t.Parallel()
...
// TestEventhubNamespaceSecurityConfiguration tests security features
func TestEventhubNamespaceSecurityConfiguration(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
	t.Parallel()
...
// TestEventhubNamespaceLifecycle tests the complete lifecycle
func TestEventhubNamespaceLifecycle(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
	t.Parallel()
...
// TestEventhubNamespaceCompliance tests compliance-related features
func TestEventhubNamespaceCompliance(t *testing.T) {
	t.Parallel()
	...
	complianceChecks := []struct {
		...
		// TODO: Add eventhub_namespace specific compliance checks
		// Examples:
		// {
		//     name:    "HTTPS Only",
