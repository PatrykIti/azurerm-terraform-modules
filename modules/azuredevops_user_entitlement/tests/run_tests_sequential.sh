...
tests=(
    "TestBasicAzuredevopsUserEntitlement"
    "TestCompleteAzuredevopsUserEntitlement"
    "TestSecureAzuredevopsUserEntitlement"
    "TestAzuredevopsUserEntitlementValidationRules"
    "TestAzuredevopsUserEntitlementFullIntegration"
)

echo "Starting sequential test execution for azuredevops_user_entitlement"
