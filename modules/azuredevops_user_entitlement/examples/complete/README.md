...
This example assigns two users with different license types.
...
|------|-------------|------|---------|:--------:|
| <a name="input_automation_user_principal_name"></a> [automation\_user\_principal\_name](#input\_automation\_user\_principal\_name) | User principal name for the automation entitlement. | `string` | n/a | yes |
