...
tests=(
    "TestBasicServicePlan"
    "TestCompleteServicePlan"
    "TestSecureServicePlan"
    "TestServicePlanValidationRules"
    "TestServicePlanFullIntegration"
    "TestServicePlanWithDiagnosticSettings"
    "TestServicePlanSecureConfiguration"
    "TestServicePlanCompliance"
    "TestServicePlanLifecycle"
    "TestServicePlanCreationTime"
    "BenchmarkServicePlanCreation"
)

echo "Starting sequential test execution for azurerm_service_plan"
