...
| <a name="output_policy_ids"></a> [policy\_ids](#output\_policy\_ids) | Map of policy IDs grouped by policy type and keyed by branch name (single policies) or policy name (list policies). |
