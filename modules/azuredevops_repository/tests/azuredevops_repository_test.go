...
func TestBasicAzuredevopsRepository(t *testing.T) {
	...
	test_structure.RunTestStage(t, "validate", func() {
		...
		// Add azuredevops_repository specific validations here
	})
}

// Test complete azuredevops_repository with all features
...
func TestNetworkAzuredevopsRepository(t *testing.T) {
	t.Parallel()
...
func TestAzuredevopsRepositoryPrivateEndpoint(t *testing.T) {
	t.Parallel()
...
func TestAzuredevopsRepositoryValidationRules(t *testing.T) {
	...
	testCases := []struct {
		...
		// Add more validation test cases specific to azuredevops_repository
	}
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			testFolder := test_structure.CopyTerraformFolderToTemp(t, "../..", fmt.Sprintf("azuredevops_repository/tests/fixtures/%s", tc.fixtureFile))
