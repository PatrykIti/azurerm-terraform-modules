...
// BenchmarkAzuredevopsRepositoryCreationSimple benchmarks simple azuredevops_repository creation
func BenchmarkAzuredevopsRepositoryCreationSimple(b *testing.B) {
	b.ReportAllocs()

	for i := 0; i < b.N; i++ {
		b.StopTimer()
		testFolder := test_structure.CopyTerraformFolderToTemp(b, "../..", "azuredevops_repository/tests/fixtures/basic")
...
// BenchmarkAzuredevopsRepositoryCreationWithFeatures benchmarks azuredevops_repository with various features
func BenchmarkAzuredevopsRepositoryCreationWithFeatures(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkAzuredevopsRepositoryCreationWithScale benchmarks with different scale configurations
func BenchmarkAzuredevopsRepositoryCreationWithScale(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkAzuredevopsRepositoryParallelCreation benchmarks parallel creation of azuredevops_repository
func BenchmarkAzuredevopsRepositoryParallelCreation(b *testing.B) {
...
// TestAzuredevopsRepositoryCreationTime validates creation time is within acceptable limits
func TestAzuredevopsRepositoryCreationTime(t *testing.T) {
	if testing.Short() {
	...
	// azuredevops_repository creation should complete within 5 minutes
	// Adjust this based on the actual expected creation time for the resource
	maxDuration := 5 * time.Minute
	require.LessOrEqual(t, duration, maxDuration,
		"Azure DevOps Repository creation took %v, expected less than %v", duration, maxDuration)

	t.Logf("Azure DevOps Repository created in %v", duration)
}

// TestAzuredevopsRepositoryScaling tests creating multiple azuredevops_repository instances
func TestAzuredevopsRepositoryScaling(t *testing.T) {
	if testing.Short() {
	...
	for i := 0; i < instanceCount; i++ {
		...
		t.Logf("Azure DevOps Repository instance %d created in %v", i, creationTimes[i])
	}
	...
	t.Logf("Average creation time for %d azuredevops_repository instances: %v", instanceCount, avgTime)
...
// TestAzuredevopsRepositoryUpdatePerformance tests update performance
func TestAzuredevopsRepositoryUpdatePerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
	...
	updateScenarios := []struct {
		...
		// Add more update scenarios specific to azuredevops_repository
	}
...
// TestAzuredevopsRepositoryDestroyPerformance tests destroy performance
func TestAzuredevopsRepositoryDestroyPerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
	...
	t.Logf("Azure DevOps Repository destroyed in %v", destroyTime)
