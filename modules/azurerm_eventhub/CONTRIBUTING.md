# Contributing to azurerm_eventhub Module
...
6. Commit using conventional commits: `feat(eventhub): add new feature`
...
```bash
feat(eventhub): add support for new feature
fix(eventhub): correct validation logic
docs(eventhub): update README examples
```
