...
tests=(
    "TestBasicEventhub"
    "TestCompleteEventhub"
    "TestSecureEventhub"
    "TestNetworkEventhub"
    "TestEventhubPrivateEndpoint"
    "TestEventhubValidationRules"
    "TestEventhubFullIntegration"
    "TestEventhubLifecycle"
    "TestEventhubCreationTime"
    "BenchmarkEventhubCreation"
)

echo "Starting sequential test execution for azurerm_eventhub"
