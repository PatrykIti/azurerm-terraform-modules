...
| <a name="input_message_retention"></a> [message\_retention](#input\_message\_retention) | Specifies the number of days to retain events. Valid range is 1-90. | `number` | `1` | no |
| <a name="input_name"></a> [name](#input\_name) | The name of the Event Hub. | `string` | n/a | yes |
| <a name="input_namespace_id"></a> [namespace\_id](#input\_namespace\_id) | The ID of the Event Hub Namespace. Prefer this over namespace\_name/resource\_group\_name. | `string` | `null` | no |
| <a name="input_namespace_name"></a> [namespace\_name](#input\_namespace\_name) | The name of the Event Hub Namespace (deprecated in provider; use namespace\_id when possible). | `string` | `null` | no |
...
| <a name="input_resource_group_name"></a> [resource\_group\_name](#input\_resource\_group\_name) | The resource group name of the Event Hub Namespace (required when namespace\_name is used). | `string` | `null` | no |
