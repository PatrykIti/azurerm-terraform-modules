...
This example demonstrates how to create Application Insights workbooks.
...
|------|-------------|------|---------|:--------:|
| <a name="input_application_insights_name"></a> [application\_insights\_name](#input\_application\_insights\_name) | Name of the Application Insights component. | `string` | `"appi-workbooks-example"` | no |
| <a name="input_location"></a> [location](#input\_location) | Azure region for resources. | `string` | `"westeurope"` | no |
| <a name="input_resource_group_name"></a> [resource\_group\_name](#input\_resource\_group\_name) | Name of the resource group for the example. | `string` | `"rg-appins-workbooks-example"` | no |
...
| <a name="output_workbooks"></a> [workbooks](#output\_workbooks) | Workbooks created by the module. |
<!-- END_TF_DOCS -->
