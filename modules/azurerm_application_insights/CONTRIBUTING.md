# Contributing to azurerm_application_insights Module
...
6. Commit using conventional commits: `feat(application-insights): add new feature`
...
```bash
feat(application-insights): add support for new feature
fix(application-insights): correct validation logic
docs(application-insights): update README examples
```
