...
tests=(
    "TestBasicApplicationInsights"
    "TestCompleteApplicationInsights"
    "TestSecureApplicationInsights"
    "TestNetworkApplicationInsights"
    "TestApplicationInsightsPrivateEndpoint"
    "TestApplicationInsightsValidationRules"
    "TestApplicationInsightsFullIntegration"
    "TestApplicationInsightsLifecycle"
    "TestApplicationInsightsCreationTime"
    "BenchmarkApplicationInsightsCreation"
)

echo "Starting sequential test execution for azurerm_application_insights"
