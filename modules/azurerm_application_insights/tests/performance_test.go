...
// BenchmarkApplicationInsightsCreationSimple benchmarks simple application_insights creation
func BenchmarkApplicationInsightsCreationSimple(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkApplicationInsightsCreationWithFeatures benchmarks application_insights with various features
func BenchmarkApplicationInsightsCreationWithFeatures(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkApplicationInsightsCreationWithScale benchmarks with different scale configurations
func BenchmarkApplicationInsightsCreationWithScale(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkApplicationInsightsParallelCreation benchmarks parallel creation of application_insights
func BenchmarkApplicationInsightsParallelCreation(b *testing.B) {
...
// TestApplicationInsightsCreationTime validates creation time is within acceptable limits
func TestApplicationInsightsCreationTime(t *testing.T) {
	if testing.Short() {
	...
	// application_insights creation should complete within 5 minutes
	// Adjust this based on the actual expected creation time for the resource
	maxDuration := 5 * time.Minute
	require.LessOrEqual(t, duration, maxDuration,
		"Application Insights creation took %v, expected less than %v", duration, maxDuration)

	t.Logf("Application Insights created in %v", duration)
}

// TestApplicationInsightsScaling tests creating multiple application_insights instances
func TestApplicationInsightsScaling(t *testing.T) {
	if testing.Short() {
	...
	for i := 0; i < instanceCount; i++ {
		...
		t.Logf("Application Insights instance %d created in %v", i, creationTimes[i])
	}
	...
	t.Logf("Average creation time for %d application_insights instances: %v", instanceCount, avgTime)
...
// TestApplicationInsightsUpdatePerformance tests update performance
func TestApplicationInsightsUpdatePerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
	...
	updateScenarios := []struct {
		...
		// Add more update scenarios specific to application_insights
	}
...
// TestApplicationInsightsDestroyPerformance tests destroy performance
func TestApplicationInsightsDestroyPerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
	...
	t.Logf("Application Insights destroyed in %v", destroyTime)
