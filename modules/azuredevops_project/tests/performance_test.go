...
// BenchmarkAzuredevopsProjectCreationSimple benchmarks simple azuredevops_project creation
func BenchmarkAzuredevopsProjectCreationSimple(b *testing.B) {
	b.ReportAllocs()

	for i := 0; i < b.N; i++ {
		b.StopTimer()
		testFolder := test_structure.CopyTerraformFolderToTemp(b, "../..", "azuredevops_project/tests/fixtures/basic")
...
// BenchmarkAzuredevopsProjectCreationWithFeatures benchmarks azuredevops_project with various features
func BenchmarkAzuredevopsProjectCreationWithFeatures(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkAzuredevopsProjectCreationWithScale benchmarks with different scale configurations
func BenchmarkAzuredevopsProjectCreationWithScale(b *testing.B) {
	b.ReportAllocs()
...
// BenchmarkAzuredevopsProjectParallelCreation benchmarks parallel creation of azuredevops_project
func BenchmarkAzuredevopsProjectParallelCreation(b *testing.B) {
...
// TestAzuredevopsProjectCreationTime validates creation time is within acceptable limits
func TestAzuredevopsProjectCreationTime(t *testing.T) {
	if testing.Short() {
	...
	// azuredevops_project creation should complete within 5 minutes
	// Adjust this based on the actual expected creation time for the resource
	maxDuration := 5 * time.Minute
	require.LessOrEqual(t, duration, maxDuration,
		"Azure DevOps Project creation took %v, expected less than %v", duration, maxDuration)

	t.Logf("Azure DevOps Project created in %v", duration)
}

// TestAzuredevopsProjectScaling tests creating multiple azuredevops_project instances
func TestAzuredevopsProjectScaling(t *testing.T) {
	if testing.Short() {
	...
	for i := 0; i < instanceCount; i++ {
		...
		t.Logf("Azure DevOps Project instance %d created in %v", i, creationTimes[i])
	}
	...
	t.Logf("Average creation time for %d azuredevops_project instances: %v", instanceCount, avgTime)
...
// TestAzuredevopsProjectUpdatePerformance tests update performance
func TestAzuredevopsProjectUpdatePerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
	...
	updateScenarios := []struct {
		...
		// Add more update scenarios specific to azuredevops_project
	}
...
// TestAzuredevopsProjectDestroyPerformance tests destroy performance
func TestAzuredevopsProjectDestroyPerformance(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping performance test in short mode")
	}
	t.Parallel()
	...
	t.Logf("Azure DevOps Project destroyed in %v", destroyTime)
