# Azure DevOps Project Module Tests

This directory contains automated tests for the Azure DevOps Project Terraform module using [Terratest](https://terratest.gruntwork.io/).
...
- `azuredevops_project_test.go` - Basic, complete, secure, and validation tests
...
```bash
go test -v -run TestBasicAzuredevopsProject
```
