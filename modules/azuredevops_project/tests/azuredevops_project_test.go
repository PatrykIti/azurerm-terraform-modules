...
func TestBasicAzuredevopsProject(t *testing.T) {
	...
	test_structure.RunTestStage(t, "validate", func() {
		...
		// Add azuredevops_project specific validations here
	})
}

// Test complete azuredevops_project with all features
...
func TestNetworkAzuredevopsProject(t *testing.T) {
	t.Parallel()
...
func TestAzuredevopsProjectPrivateEndpoint(t *testing.T) {
	t.Parallel()
...
func TestAzuredevopsProjectValidationRules(t *testing.T) {
	...
	testCases := []struct {
		...
		// Add more validation test cases specific to azuredevops_project
	}
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			testFolder := test_structure.CopyTerraformFolderToTemp(t, "../..", fmt.Sprintf("azuredevops_project/tests/fixtures/%s", tc.fixtureFile))
