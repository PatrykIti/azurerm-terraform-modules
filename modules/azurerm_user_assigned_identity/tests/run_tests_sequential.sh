...
tests=(
    "TestBasicUserAssignedIdentity"
    "TestCompleteUserAssignedIdentity"
    "TestSecureUserAssignedIdentity"
    "TestNetworkUserAssignedIdentity"
    "TestUserAssignedIdentityPrivateEndpoint"
    "TestUserAssignedIdentityValidationRules"
    "TestUserAssignedIdentityFullIntegration"
    "TestUserAssignedIdentityLifecycle"
    "TestUserAssignedIdentityCreationTime"
    "BenchmarkUserAssignedIdentityCreation"
)

echo "Starting sequential test execution for azurerm_user_assigned_identity"
