# Contributing to azurerm_user_assigned_identity Module
...
6. Commit using conventional commits: `feat(user-assigned-identity): add new feature`
...
```bash
feat(user-assigned-identity): add support for new feature
fix(user-assigned-identity): correct validation logic
docs(user-assigned-identity): update README examples
```
